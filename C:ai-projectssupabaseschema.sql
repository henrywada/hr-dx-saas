...
ALTER TABLE ONLY "public"."service_assignments"
    ADD CONSTRAINT "service_assignments_tenant_id_service_type_key" UNIQUE ("tenant_id", "service_type");
...
CREATE INDEX "idx_sau_assignment_id" ON "public"."service_assignments_users" USING "btree" ("service_assignment_id");



CREATE INDEX "idx_sau_tenant_employee" ON "public"."service_assignments_users" USING "btree" ("tenant_id", "employee_id");
...
CREATE POLICY "tenant_isolation_sa" ON "public"."service_assignments" USING (("tenant_id" = ("current_setting"('app.current_tenant_id'::"text"))::"uuid")) WITH CHECK (("tenant_id" = ("current_setting"('app.current_tenant_id'::"text"))::"uuid"));



CREATE POLICY "tenant_isolation_sau" ON "public"."service_assignments_users" USING (("tenant_id" = ("current_setting"('app.current_tenant_id'::"text"))::"uuid")) WITH CHECK (("tenant_id" = ("current_setting"('app.current_tenant_id'::"text"))::"uuid"));
