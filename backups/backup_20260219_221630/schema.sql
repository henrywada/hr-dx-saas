...
ALTER TABLE "public"."system_logs" OWNER TO "supabase_admin";
...
ALTER TABLE ONLY "public"."system_logs"
    ADD CONSTRAINT "system_logs_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."system_logs"
    ADD CONSTRAINT "system_logs_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");
...
GRANT ALL ON TABLE "public"."system_logs" TO "postgres";
