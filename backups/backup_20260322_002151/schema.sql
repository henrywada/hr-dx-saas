...
CREATE POLICY "overtime_alerts_tenant_select" ON "public"."overtime_alerts" FOR SELECT TO "authenticated" USING (("tenant_id" = "public"."current_tenant_id"()));
...
CREATE POLICY "overtime_monthly_stats_tenant_select" ON "public"."overtime_monthly_stats" FOR SELECT TO "authenticated" USING (("tenant_id" = "public"."current_tenant_id"()));
...
CREATE POLICY "work_time_records_tenant_select" ON "public"."work_time_records" FOR SELECT TO "authenticated" USING (("tenant_id" = "public"."current_tenant_id"()));
