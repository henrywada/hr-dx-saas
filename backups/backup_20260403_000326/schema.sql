...
CREATE OR REPLACE FUNCTION "public"."get_overtime_trend"("p_tenant_id" "uuid") RETURNS TABLE("year_month" "date", "avg_overtime" numeric, "max_overtime" numeric, "total_employees" bigint, "violation_count" bigint)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."get_overtime_trend"("p_tenant_id" "uuid") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."get_overtime_trend"("p_tenant_id" "uuid") IS '過去12ヶ月のテナント別残業トレンド（月次集計）';
...
CREATE TABLE IF NOT EXISTS "public"."stress_interview_records" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "stress_result_id" "uuid" NOT NULL,
    "doctor_id" "uuid" NOT NULL,
...
REVOKE ALL ON FUNCTION "public"."get_overtime_trend"("p_tenant_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_overtime_trend"("p_tenant_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_overtime_trend"("p_tenant_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_overtime_trend"("p_tenant_id" "uuid") TO "service_role";
