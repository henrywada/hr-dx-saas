...
CREATE TABLE IF NOT EXISTS "public"."global_job_categories" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "sort_order" integer DEFAULT 0 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL
...
ALTER TABLE "public"."global_job_categories" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."global_job_roles" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."global_job_roles" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."global_skill_items" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."global_skill_items" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."skill_approvers" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "employee_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."skill_approvers" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."global_job_categories"
    ADD CONSTRAINT "global_job_categories_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."global_job_roles"
    ADD CONSTRAINT "global_job_roles_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."global_skill_items"
    ADD CONSTRAINT "global_skill_items_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "global_job_roles_category_id_idx" ON "public"."global_job_roles" USING "btree" ("category_id");



CREATE INDEX "global_skill_items_job_role_id_idx" ON "public"."global_skill_items" USING "btree" ("job_role_id");



CREATE INDEX "global_skill_items_skill_level_set_id_idx" ON "public"."global_skill_items" USING "btree" ("skill_level_set_id");
...
ALTER TABLE ONLY "public"."global_job_roles"
    ADD CONSTRAINT "global_job_roles_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."global_job_categories"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."global_skill_items"
    ADD CONSTRAINT "global_skill_items_job_role_id_fkey" FOREIGN KEY ("job_role_id") REFERENCES "public"."global_job_roles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."global_skill_items"
    ADD CONSTRAINT "global_skill_items_skill_level_set_id_fkey" FOREIGN KEY ("skill_level_set_id") REFERENCES "public"."global_skill_level_sets"("id") ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."skill_approvers"
    ADD CONSTRAINT "skill_approvers_approver_id_fkey" FOREIGN KEY ("approver_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_approvers"
    ADD CONSTRAINT "skill_approvers_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_approvers"
    ADD CONSTRAINT "skill_approvers_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;
...
CREATE POLICY "tenant_isolation" ON "public"."skill_approvers" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));
...
GRANT ALL ON TABLE "public"."global_job_categories" TO "anon";
GRANT ALL ON TABLE "public"."global_job_categories" TO "authenticated";
GRANT ALL ON TABLE "public"."global_job_categories" TO "service_role";



GRANT ALL ON TABLE "public"."global_job_roles" TO "anon";
GRANT ALL ON TABLE "public"."global_job_roles" TO "authenticated";
GRANT ALL ON TABLE "public"."global_job_roles" TO "service_role";



GRANT ALL ON TABLE "public"."global_skill_items" TO "anon";
GRANT ALL ON TABLE "public"."global_skill_items" TO "authenticated";
GRANT ALL ON TABLE "public"."global_skill_items" TO "service_role";
...
GRANT ALL ON TABLE "public"."skill_approvers" TO "anon";
GRANT ALL ON TABLE "public"."skill_approvers" TO "authenticated";
GRANT ALL ON TABLE "public"."skill_approvers" TO "service_role";
