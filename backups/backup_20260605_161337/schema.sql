...
CREATE OR REPLACE FUNCTION "public"."resolve_active_period_for_employee_v2"("p_employee_id" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."resolve_active_period_for_employee_v2"("p_employee_id" "uuid") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."resolve_active_period_for_employee_v2"("p_employee_id" "uuid") IS '従業員の division + 祖先チェーンから有効な stress_check_period を解決する（division ベース新方式）';



CREATE OR REPLACE FUNCTION "public"."resolve_division_establishment_for_division"("p_division_id" "uuid", "p_tenant_id" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."resolve_division_establishment_for_division"("p_division_id" "uuid", "p_tenant_id" "uuid") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."resolve_division_establishment_for_division"("p_division_id" "uuid", "p_tenant_id" "uuid") IS '所属 division から親を遡り、最初に一致する拠点アンカーに対応する division_establishments.id を返す';



CREATE OR REPLACE FUNCTION "public"."resolve_division_establishment_for_employee"("p_employee_id" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."resolve_division_establishment_for_employee"("p_employee_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."stress_group_analysis_for_layer"("p_tenant_id" "uuid", "p_layer" integer) RETURNS TABLE("rollup_division_id" "uuid", "name" "text", "tenant_id" "uuid", "member_count" bigint, "high_stress_rate" numeric, "health_risk" numeric, "workload" numeric, "control" numeric, "supervisor_support" numeric, "colleague_support" numeric, "previous_health_risk" numeric, "period_name" "text", "period_end_date" "date", "is_latest" boolean, "is_suppressed" boolean, "min_respondents_threshold" integer)
    LANGUAGE "sql" STABLE
    SET "search_path" TO 'public'
    AS $$
...
ALTER FUNCTION "public"."stress_group_analysis_for_layer"("p_tenant_id" "uuid", "p_layer" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_candidate_timestamps"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_candidate_timestamps"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."candidates" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "candidates_stage_check" CHECK (("stage" = ANY (ARRAY['applied'::"text", 'screening'::"text", 'interview_1'::"text", 'interview_2'::"text", 'final'::"text", 'offered'::"text", 'hired'::"text", 'rejected'::"text", 'withdrawn'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."division_establishment_anchors" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "division_establishment_id" "uuid" NOT NULL,
    "division_id" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL
);


ALTER TABLE "public"."division_establishment_anchors" OWNER TO "postgres";
...
ALTER TABLE "public"."division_establishments" OWNER TO "postgres";
...
ALTER TABLE "public"."el_assignments" OWNER TO "postgres";
...
ALTER TABLE "public"."el_checklist_completions" OWNER TO "postgres";


COMMENT ON TABLE "public"."el_checklist_completions" IS '受講者が現場適用チェックリストの各項目を完了したことを記録する。コース完了後も随時追加可能。';
...
ALTER TABLE "public"."el_checklist_items" OWNER TO "postgres";


COMMENT ON TABLE "public"."el_checklist_items" IS '現場適用チェックリストの各項目。1スライドに3〜5件を推奨。';



COMMENT ON COLUMN "public"."el_checklist_items"."item_text" IS '「〇〇した」「〇〇を確認した」等の過去形・完了形で記述する行動文。';



CREATE TABLE IF NOT EXISTS "public"."el_course_requirement_mappings" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "course_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."el_course_requirement_mappings" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."el_course_skill_level_mappings" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "course_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."el_course_skill_level_mappings" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."el_courses" (
    ...
    "title" "text" NOT NULL,
    "description" "text",
    "category" "text" DEFAULT '初級'::"text" NOT NULL,
    "status" "text" DEFAULT 'draft'::"text" NOT NULL,
    "course_type" "text" DEFAULT 'tenant'::"text" NOT NULL,
    ...
    CONSTRAINT "el_courses_bloom_level_check" CHECK (("bloom_level" = ANY (ARRAY['remember'::"text", 'understand'::"text", 'apply'::"text", 'analyze'::"text", 'evaluate'::"text", 'create'::"text"]))),
    CONSTRAINT "el_courses_course_type_check" CHECK (("course_type" = ANY (ARRAY['template'::"text", 'tenant'::"text"]))),
    CONSTRAINT "el_courses_status_check" CHECK (("status" = ANY (ARRAY['draft'::"text", 'published'::"text", 'archived'::"text"])))
);


ALTER TABLE "public"."el_courses" OWNER TO "postgres";
...
COMMENT ON COLUMN "public"."el_courses"."bloom_level" IS 'Bloom''s Taxonomy に基づく認知レベル（remember / understand / apply / analyze / evaluate / create）';



COMMENT ON COLUMN "public"."el_courses"."learning_objectives" IS '「〇〇できる」形式の学習目標リスト。受講者に最初に提示する。';
...
CREATE TABLE IF NOT EXISTS "public"."el_progress" (
    ...
    CONSTRAINT "el_progress_quiz_score_check" CHECK ((("quiz_score" IS NULL) OR (("quiz_score" >= 0) AND ("quiz_score" <= 100)))),
    CONSTRAINT "el_progress_status_check" CHECK (("status" = ANY (ARRAY['not_started'::"text", 'in_progress'::"text", 'completed'::"text"])))
);


ALTER TABLE "public"."el_progress" OWNER TO "postgres";


COMMENT ON COLUMN "public"."el_progress"."scenario_branch_id" IS 'シナリオスライドで受講者が選択した分岐の ID。';



COMMENT ON COLUMN "public"."el_progress"."selected_choice_text" IS '選択時の choice_text スナップショット（分岐が後から削除されても内容を保持）。';
...
ALTER TABLE "public"."el_quiz_options" OWNER TO "postgres";
...
ALTER TABLE "public"."el_quiz_questions" OWNER TO "postgres";
...
ALTER TABLE "public"."el_scenario_branches" OWNER TO "postgres";


COMMENT ON TABLE "public"."el_scenario_branches" IS 'シナリオスライドの分岐選択肢。1スライドに2〜4件程度を想定。';



COMMENT ON COLUMN "public"."el_scenario_branches"."is_recommended" IS 'TRUE の選択肢が「模範解答」。複数設定可（例: B と C はどちらも推奨）。';
...
CREATE TABLE IF NOT EXISTS "public"."el_slides" (
    ...
    "slide_type" "text" DEFAULT 'text'::"text" NOT NULL,
    "title" "text",
    "content" "text",
    "image_url" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    ...
    CONSTRAINT "el_slides_estimated_seconds_check" CHECK ((("estimated_seconds" IS NULL) OR ("estimated_seconds" > 0))),
    CONSTRAINT "el_slides_slide_type_check" CHECK (("slide_type" = ANY (ARRAY['text'::"text", 'image'::"text", 'quiz'::"text", 'objective'::"text", 'micro_content'::"text", 'scenario'::"text", 'reflection'::"text", 'checklist'::"text"])))
);


ALTER TABLE "public"."el_slides" OWNER TO "postgres";


COMMENT ON COLUMN "public"."el_slides"."slide_type" IS 'スライド種別: text/image/quiz（既存）/ objective/micro_content/scenario/reflection/checklist（新規）';



COMMENT ON COLUMN "public"."el_slides"."video_url" IS 'Phase 2 マイクロコンテンツで埋め込む動画 URL（YouTube / Vimeo / Supabase Storage）';



COMMENT ON COLUMN "public"."el_slides"."estimated_seconds" IS 'スライド単位の想定学習時間（秒）。コース全体の estimated_minutes 算出にも利用。';
...
CREATE TABLE IF NOT EXISTS "public"."employee_approvers" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "approver_role" "text" DEFAULT 'skill_approval'::"text" NOT NULL,
    CONSTRAINT "employee_approvers_approver_role_check" CHECK (("approver_role" = ANY (ARRAY['skill_approval'::"text", 'eval_primary'::"text", 'eval_secondary'::"text", 'eval_confirmer'::"text"])))
);
...
COMMENT ON COLUMN "public"."employee_approvers"."approver_role" IS 'skill_approval=スキル承認, eval_primary=一次評価者, eval_secondary=二次評価者, eval_confirmer=確定者';
...
CREATE TABLE IF NOT EXISTS "public"."employee_career_goals" (
    ...
    "message" "text",
    CONSTRAINT "employee_career_goals_status_check" CHECK (("status" = ANY (ARRAY['proposed'::"text", 'confirmed'::"text", 'active'::"text", 'achieved'::"text"])))
);


ALTER TABLE "public"."employee_career_goals" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."employee_recommended_courses" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."employee_recommended_courses" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."employee_skill_assignments" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "employee_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."employee_skill_assignments" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."employee_skill_level_achievements" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "employee_id" "uuid" NOT NULL,
    "skill_level_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."employee_skill_level_achievements" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."employee_skill_requirement_history" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "employee_id" "uuid" NOT NULL,
    ...
    "completed_requirements" integer DEFAULT 0 NOT NULL,
    "completion_rate" numeric(5,2) DEFAULT 0.00 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL
);


ALTER TABLE "public"."employee_skill_requirement_history" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."employee_skill_requirement_selections" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "employee_id" "uuid" NOT NULL,
    "requirement_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."employee_skill_requirement_selections" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."employee_skill_self_evaluations" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "employee_id" "uuid" NOT NULL,
    "requirement_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."employee_skill_self_evaluations" OWNER TO "postgres";
...
ALTER TABLE "public"."employee_training_plans" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."evaluation_flow_logs" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."evaluation_flow_logs" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."evaluation_goals" (
    ...
    "goal_detail" "text",
    "kpi_type" "text" DEFAULT 'quantitative'::"text" NOT NULL,
    "kpi_target" "text",
    "kpi_unit" "text",
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "evaluation_goals_kpi_type_check" CHECK (("kpi_type" = ANY (ARRAY['quantitative'::"text", 'qualitative'::"text"])))
);


ALTER TABLE "public"."evaluation_goals" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."evaluation_periods" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "evaluation_periods_period_type_check" CHECK (("period_type" = ANY (ARRAY['first_half'::"text", 'second_half'::"text", 'full_year'::"text", 'quarterly'::"text"]))),
    CONSTRAINT "evaluation_periods_status_check" CHECK (("status" = ANY (ARRAY['preparation'::"text", 'goal_setting'::"text", 'in_progress'::"text", 'self_eval'::"text", 'primary_eval'::"text", 'secondary_eval'::"text", 'confirmed'::"text", 'closed'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."evaluation_reminders" (
    ...
    CONSTRAINT "evaluation_reminders_reminder_type_check" CHECK (("reminder_type" = ANY (ARRAY['deadline_approaching'::"text", 'overdue'::"text", 'bulk_nudge'::"text", 'rollback_notify'::"text"])))
);


ALTER TABLE "public"."evaluation_reminders" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."evaluation_scores" (
    ...
    CONSTRAINT "evaluation_scores_check" CHECK (((("item_id" IS NOT NULL) AND ("goal_id" IS NULL)) OR (("item_id" IS NULL) AND ("goal_id" IS NOT NULL)))),
    CONSTRAINT "evaluation_scores_evaluator_type_check" CHECK (("evaluator_type" = ANY (ARRAY['self'::"text", 'primary'::"text", 'secondary'::"text", 'confirmer'::"text"]))),
    CONSTRAINT "evaluation_scores_score_check" CHECK ((("score" >= 1) AND ("score" <= 5)))
);
...
CREATE TABLE IF NOT EXISTS "public"."evaluation_sheets" (
    ...
    "period_id" "uuid" NOT NULL,
    "template_id" "uuid" NOT NULL,
    "primary_evaluator_id" "uuid",
    "secondary_evaluator_id" "uuid",
    "confirmer_id" "uuid",
    "flow_status" "text" DEFAULT 'draft'::"text" NOT NULL,
    "final_score" numeric(4,2),
    "final_grade" "text",
    "is_locked" boolean DEFAULT false NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "evaluation_sheets_final_grade_check" CHECK ((("final_grade" = ANY (ARRAY['S'::"text", 'A'::"text", 'B'::"text", 'C'::"text", 'D'::"text"])) OR ("final_grade" IS NULL))),
    CONSTRAINT "evaluation_sheets_flow_status_check" CHECK (("flow_status" = ANY (ARRAY['draft'::"text", 'goal_set'::"text", 'self_eval'::"text", 'self_submitted'::"text", 'primary_eval'::"text", 'primary_submitted'::"text", 'secondary_eval'::"text", 'secondary_submitted'::"text", 'confirming'::"text", 'confirmed'::"text"])))
);


ALTER TABLE "public"."evaluation_sheets" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."evaluation_template_items" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "template_id" "uuid" NOT NULL,
    "axis" "text" NOT NULL,
    ...
    "target_grade_note" "text",
    CONSTRAINT "evaluation_template_items_axis_check" CHECK (("axis" = ANY (ARRAY['performance'::"text", 'ability'::"text", 'attitude'::"text", 'mbo'::"text"]))),
    CONSTRAINT "evaluation_template_items_mbo_category_check" CHECK ((("mbo_category" = ANY (ARRAY['A'::"text", 'B'::"text", 'C'::"text", 'D'::"text"])) OR ("mbo_category" IS NULL)))
);
...
CREATE TABLE IF NOT EXISTS "public"."evaluation_templates" (
    ...
    "is_active" boolean DEFAULT true NOT NULL,
    "sort_order" integer DEFAULT 0 NOT NULL,
    "copied_from_global_at" timestamp with time zone,
    "created_by" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "evaluation_templates_template_type_check" CHECK (("template_type" = ANY (ARRAY['general'::"text", 'manager'::"text", 'parttime'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."global_evaluation_template_items" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "template_id" "uuid" NOT NULL,
    "axis" "text" NOT NULL,
    "mbo_category" "text",
    ...
    "measurement_method" "text",
    "target_grade_note" "text",
    CONSTRAINT "global_evaluation_template_items_axis_check" CHECK (("axis" = ANY (ARRAY['performance'::"text", 'ability'::"text", 'attitude'::"text", 'mbo'::"text"]))),
    CONSTRAINT "global_evaluation_template_items_mbo_category_check" CHECK ((("mbo_category" = ANY (ARRAY['A'::"text", 'B'::"text", 'C'::"text", 'D'::"text"])) OR ("mbo_category" IS NULL)))
);


ALTER TABLE "public"."global_evaluation_template_items" OWNER TO "postgres";
...
COMMENT ON COLUMN "public"."global_evaluation_template_items"."evaluation_focus" IS '評価の着眼点：何を見て評価するかの具体的な観点';



COMMENT ON COLUMN "public"."global_evaluation_template_items"."measurement_method" IS '測定方法・指標例：数値指標や定性評価の方法（カンマ区切りでタグ的に使用）';



COMMENT ON COLUMN "public"."global_evaluation_template_items"."target_grade_note" IS '対象等級メモ：全等級 / 中堅〜 / 管理職のみ 等';



CREATE TABLE IF NOT EXISTS "public"."global_evaluation_templates" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "template_type" "text" NOT NULL,
    "description" "text",
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "global_evaluation_templates_template_type_check" CHECK (("template_type" = ANY (ARRAY['general'::"text", 'manager'::"text", 'parttime'::"text"])))
);


ALTER TABLE "public"."global_evaluation_templates" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."global_skill_level_sets" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "sort_order" integer DEFAULT 0 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."global_skill_level_sets" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."global_skill_levels" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "criteria" "text",
    ...
    "sort_order" integer DEFAULT 0 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "skill_level_set_id" "uuid" NOT NULL
);


ALTER TABLE "public"."global_skill_levels" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."grade_evaluation_criteria" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."grade_evaluation_criteria" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."lifecycle_instances" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "completed_at" timestamp with time zone,
    CONSTRAINT "lifecycle_instances_lifecycle_type_check" CHECK (("lifecycle_type" = ANY (ARRAY['onboarding'::"text", 'offboarding'::"text"]))),
    CONSTRAINT "lifecycle_instances_status_check" CHECK (("status" = ANY (ARRAY['in_progress'::"text", 'completed'::"text", 'cancelled'::"text"])))
);


ALTER TABLE "public"."lifecycle_instances" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."lifecycle_task_templates" (
    ...
    "is_active" boolean DEFAULT true NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "lifecycle_task_templates_lifecycle_type_check" CHECK (("lifecycle_type" = ANY (ARRAY['onboarding'::"text", 'offboarding'::"text"])))
);


ALTER TABLE "public"."lifecycle_task_templates" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."lifecycle_tasks" (
    ...
    "completed_at" timestamp with time zone,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "lifecycle_tasks_status_check" CHECK (("status" = ANY (ARRAY['pending'::"text", 'in_progress'::"text", 'completed'::"text"])))
);


ALTER TABLE "public"."lifecycle_tasks" OWNER TO "postgres";
...
ALTER TABLE "public"."one_on_one_sessions" OWNER TO "postgres";
...
ALTER TABLE "public"."one_on_one_theme_templates" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."project_simulations" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "project_simulations_status_check" CHECK (("status" = ANY (ARRAY['draft'::"text", 'approved'::"text", 'archived'::"text"])))
);


ALTER TABLE "public"."project_simulations" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."pulse_survey_responses" (
    ...
    "comment" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "pulse_survey_responses_score_check" CHECK ((("score" IS NULL) OR (("score" >= 1) AND ("score" <= 10))))
);
...
COMMENT ON COLUMN "public"."pulse_survey_responses"."score" IS '1〜10。評価表は10段階（1-10）、単一選択は選択肢順の1-n（最大10）';
...
CREATE TABLE IF NOT EXISTS "public"."questionnaire_periods" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "questionnaire_id" "uuid" NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "period_type" "text" DEFAULT 'none'::"text" NOT NULL,
    "label" "text",
    "start_date" "date",
    "end_date" "date",
    "status" "text" DEFAULT 'active'::"text" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "hr_message" "text",
    CONSTRAINT "questionnaire_periods_period_type_check" CHECK (("period_type" = ANY (ARRAY['weekly'::"text", 'monthly'::"text", 'date_range'::"text", 'none'::"text"]))),
    CONSTRAINT "questionnaire_periods_status_check" CHECK (("status" = ANY (ARRAY['active'::"text", 'closed'::"text"])))
);


ALTER TABLE "public"."questionnaire_periods" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."questionnaires" (
    ...
    CONSTRAINT "questionnaires_purpose_check" CHECK (("purpose" = ANY (ARRAY['general'::"text", 'echo'::"text"]))),
...
CREATE TABLE IF NOT EXISTS "public"."simulation_assigned_members" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."simulation_assigned_members" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."simulation_position_requirements" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "position_id" "uuid" NOT NULL,
    "requirement_id" "uuid" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "simulation_position_requirements_weight_check" CHECK ((("weight" >= 1) AND ("weight" <= 5)))
);


ALTER TABLE "public"."simulation_position_requirements" OWNER TO "postgres";
...
ALTER TABLE "public"."simulation_positions" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."skill_consultations" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "employee_id" "uuid" NOT NULL,
    "manager_id" "uuid" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "skill_consultations_status_check" CHECK (("status" = ANY (ARRAY['open'::"text", 'replied'::"text", 'resolved'::"text"])))
);


ALTER TABLE "public"."skill_consultations" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."skill_feedback_comments" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "skill_feedback_comments_category_check" CHECK ((("category")::"text" = ANY ((ARRAY['skill_approval'::character varying, '1on1'::character varying, 'career_goal'::character varying])::"text"[])))
);


ALTER TABLE "public"."skill_feedback_comments" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."skill_growth_milestones" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "employee_id" "uuid" NOT NULL,
    "title" "text" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "skill_growth_milestones_status_check" CHECK (("status" = ANY (ARRAY['proposed'::"text", 'confirmed'::"text", 'in_progress'::"text", 'completed'::"text", 'changed'::"text"])))
);


ALTER TABLE "public"."skill_growth_milestones" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."skill_map_drafts" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "name" "text" NOT NULL,
    "created_by" "uuid",
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "skill_map_drafts_status_check" CHECK (("status" = ANY (ARRAY['draft'::"text", 'confirmed'::"text"])))
);


ALTER TABLE "public"."skill_map_drafts" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."skill_requirement_applications" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "employee_id" "uuid" NOT NULL,
    "requirement_id" "uuid" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "skill_requirement_applications_status_check" CHECK (("status" = ANY (ARRAY['pending_manager'::"text", 'pending_hr'::"text", 'approved'::"text", 'rejected'::"text"])))
);


ALTER TABLE "public"."skill_requirement_applications" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."skill_role_applications" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "employee_id" "uuid" NOT NULL,
    "skill_id" "uuid" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "skill_role_applications_status_check" CHECK (("status" = ANY (ARRAY['pending_manager'::"text", 'pending_hr'::"text", 'approved'::"text", 'rejected'::"text"])))
);


ALTER TABLE "public"."skill_role_applications" OWNER TO "postgres";
...
ALTER TABLE "public"."stress_check_period_divisions" OWNER TO "postgres";


COMMENT ON TABLE "public"."stress_check_period_divisions" IS '実施グループ（stress_check_periods）と対象部署（divisions）の紐付け。
...
CREATE TABLE IF NOT EXISTS "public"."stress_check_periods" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "division_establishment_id" "uuid",
    "comment" "text",
    "workplace_name" "text",
    "workplace_address" "text",
    "labor_office_name" "text",
...
COMMENT ON COLUMN "public"."stress_check_periods"."comment" IS '実施グループへのコメント・備考（任意）';
...
CREATE TABLE IF NOT EXISTS "public"."tenant_stress_settings" (
    "tenant_id" "uuid" NOT NULL,
    "min_group_analysis_respondents" integer DEFAULT 11 NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "tenant_stress_settings_min_group_analysis_respondents_check" CHECK ((("min_group_analysis_respondents" >= 1) AND ("min_group_analysis_respondents" <= 10000)))
);


ALTER TABLE "public"."tenant_stress_settings" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."stress_group_analysis_establishment" WITH ("security_invoker"='true') AS
 WITH "base" AS (
         SELECT "de"."id" AS "division_establishment_id",
            ...
            "round"("avg"("sr"."score_c"), 1) AS "supervisor_support",
            "round"("avg"("sr"."score_d"), 1) AS "colleague_support",
            "lag"((((("avg"("sr"."score_a") + "avg"("sr"."score_b")) + "avg"("sr"."score_c")) + "avg"("sr"."score_d")) / 4.0)) OVER (PARTITION BY "de"."id" ORDER BY "sp"."end_date" DESC) AS "previous_health_risk",
            "sp"."title" AS "period_name",
            "sp"."end_date" AS "period_end_date",
            ("sp"."end_date" = "max"("sp"."end_date") OVER (PARTITION BY "de"."tenant_id")) AS "is_latest"
           FROM ((("public"."employees" "e"
             JOIN "public"."division_establishments" "de" ON (("de"."id" = "public"."resolve_division_establishment_for_division"("e"."division_id", "e"."tenant_id"))))
             JOIN "public"."stress_check_results" "sr" ON (("e"."id" = "sr"."employee_id")))
             JOIN "public"."stress_check_periods" "sp" ON ((("sr"."period_id" = "sp"."id") AND ("sp"."tenant_id" = "e"."tenant_id"))))
          GROUP BY "de"."id", "de"."name", "de"."tenant_id", "sp"."title", "sp"."end_date"
         HAVING ("count"("e"."id") >= 1)
        )
 SELECT "b"."division_establishment_id",
    "b"."establishment_name" AS "name",
    "b"."tenant_id",
    "b"."member_count",
        CASE
            WHEN ("b"."member_count" >= COALESCE("tss"."min_group_analysis_respondents", 11)) THEN "b"."high_stress_rate"
            ELSE NULL::numeric
        END AS "high_stress_rate",
        CASE
            WHEN ("b"."member_count" >= COALESCE("tss"."min_group_analysis_respondents", 11)) THEN "b"."health_risk"
            ELSE NULL::numeric
        END AS "health_risk",
        CASE
            WHEN ("b"."member_count" >= COALESCE("tss"."min_group_analysis_respondents", 11)) THEN "b"."workload"
            ELSE NULL::numeric
        END AS "workload",
        CASE
            WHEN ("b"."member_count" >= COALESCE("tss"."min_group_analysis_respondents", 11)) THEN "b"."control"
            ELSE NULL::numeric
        END AS "control",
        CASE
            WHEN ("b"."member_count" >= COALESCE("tss"."min_group_analysis_respondents", 11)) THEN "b"."supervisor_support"
            ELSE NULL::numeric
        END AS "supervisor_support",
        CASE
            WHEN ("b"."member_count" >= COALESCE("tss"."min_group_analysis_respondents", 11)) THEN "b"."colleague_support"
            ELSE NULL::numeric
        END AS "colleague_support",
        CASE
            WHEN ("b"."member_count" >= COALESCE("tss"."min_group_analysis_respondents", 11)) THEN "b"."previous_health_risk"
            ELSE NULL::numeric
...
ALTER VIEW "public"."stress_group_analysis_establishment" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."succession_candidates" (
    ...
    "position_id" "uuid" NOT NULL,
    "employee_id" "uuid" NOT NULL,
    "readiness" "text" DEFAULT 'three_to_five_years'::"text" NOT NULL,
    "performance_score" integer DEFAULT 2 NOT NULL,
    "potential_score" integer DEFAULT 2 NOT NULL,
    "development_actions" "text",
    "notes" "text",
    "sort_order" integer DEFAULT 0 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "succession_candidates_performance_score_check" CHECK ((("performance_score" >= 1) AND ("performance_score" <= 3))),
    CONSTRAINT "succession_candidates_potential_score_check" CHECK ((("potential_score" >= 1) AND ("potential_score" <= 3))),
    CONSTRAINT "succession_candidates_readiness_check" CHECK (("readiness" = ANY (ARRAY['ready_now'::"text", 'one_to_two_years'::"text", 'three_to_five_years'::"text"])))
);


ALTER TABLE "public"."succession_candidates" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."succession_positions" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "succession_positions_risk_level_check" CHECK (("risk_level" = ANY (ARRAY['high'::"text", 'medium'::"text", 'low'::"text"])))
);


ALTER TABLE "public"."succession_positions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."tenant_contracts" (
    ...
    "bank_transfer_due_date" timestamp with time zone,
    "bank_transfer_amount_received" integer DEFAULT 0 NOT NULL,
...
ALTER TABLE "public"."tenant_contracts" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."tenant_portal_settings" (
    ...
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "pulse_survey_cadence" "text" DEFAULT 'monthly'::"text" NOT NULL,
    CONSTRAINT "tenant_portal_settings_pulse_survey_cadence_check" CHECK (("pulse_survey_cadence" = ANY (ARRAY['monthly'::"text", 'weekly'::"text"])))
);
...
COMMENT ON COLUMN "public"."tenant_portal_settings"."pulse_survey_cadence" IS 'パルスサーベイ実施間隔: monthly=月1回, weekly=週1回（Echo 本番指定・パルス期間管理で共有）';
...
CREATE TABLE IF NOT EXISTS "public"."tenant_skill_level_sets" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tenant_id" "uuid" NOT NULL,
    "name" "text" NOT NULL,
    "sort_order" integer DEFAULT 0 NOT NULL,
...
ALTER TABLE "public"."tenant_skill_level_sets" OWNER TO "postgres";
...
ALTER TABLE "public"."tenant_skills" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."tenants" (
    ...
    "status" "text" DEFAULT 'active'::"text" NOT NULL,
    "stripe_customer_id" "text",
    CONSTRAINT "tenants_pulse_survey_cadence_check" CHECK (("pulse_survey_cadence" = ANY (ARRAY['monthly'::"text", 'weekly'::"text"])))
);
...
COMMENT ON COLUMN "public"."tenants"."pulse_survey_cadence" IS 'パルスサーベイの実施間隔: monthly=月1回（期間キー YYYY-MM）, weekly=週1回（ISO週・期間キー YYYY-Www）';
...
ALTER TABLE "public"."training_plan_template_courses" OWNER TO "postgres";
...
ALTER TABLE "public"."training_plan_templates" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."turnover_risk_action_logs" (
    ...
    CONSTRAINT "turnover_risk_action_logs_action_type_check" CHECK (("action_type" = ANY (ARRAY['one_on_one'::"text", 'counseling'::"text", 'manager_talk'::"text", 'hr_interview'::"text", 'other'::"text"])))
);


ALTER TABLE "public"."turnover_risk_action_logs" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."turnover_risk_scores" (
    ...
    "calculated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "turnover_risk_scores_risk_level_check" CHECK (("risk_level" = ANY (ARRAY['high'::"text", 'medium'::"text", 'low'::"text"]))),
    CONSTRAINT "turnover_risk_scores_risk_score_check" CHECK ((("risk_score" >= 0) AND ("risk_score" <= 100)))
);


ALTER TABLE "public"."turnover_risk_scores" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."workplace_improvement_plans" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    "source_division_establishment_id" "uuid",
...
ALTER TABLE ONLY "public"."division_establishment_anchors"
    ADD CONSTRAINT "division_establishment_anchors_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."division_establishment_anchors"
    ADD CONSTRAINT "division_establishment_anchors_tenant_division_unique" UNIQUE ("tenant_id", "division_id");



ALTER TABLE ONLY "public"."division_establishment_anchors"
    ADD CONSTRAINT "division_establishment_anchors_unique_pair" UNIQUE ("division_establishment_id", "division_id");



ALTER TABLE ONLY "public"."division_establishments"
    ADD CONSTRAINT "division_establishments_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."el_assignments"
    ADD CONSTRAINT "el_assignments_course_id_employee_id_key" UNIQUE ("course_id", "employee_id");



ALTER TABLE ONLY "public"."el_assignments"
    ADD CONSTRAINT "el_assignments_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."el_checklist_completions"
    ADD CONSTRAINT "el_checklist_completions_assignment_id_checklist_item_id_key" UNIQUE ("assignment_id", "checklist_item_id");



ALTER TABLE ONLY "public"."el_checklist_completions"
    ADD CONSTRAINT "el_checklist_completions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."el_checklist_items"
    ADD CONSTRAINT "el_checklist_items_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."el_course_requirement_mappings"
    ADD CONSTRAINT "el_course_requirement_mappings_course_id_requirement_id_key" UNIQUE ("course_id", "requirement_id");



ALTER TABLE ONLY "public"."el_course_requirement_mappings"
    ADD CONSTRAINT "el_course_requirement_mappings_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."el_course_skill_level_mappings"
    ADD CONSTRAINT "el_course_skill_level_mappings_course_id_skill_level_id_key" UNIQUE ("course_id", "skill_level_id");



ALTER TABLE ONLY "public"."el_course_skill_level_mappings"
    ADD CONSTRAINT "el_course_skill_level_mappings_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."el_courses"
    ADD CONSTRAINT "el_courses_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."el_progress"
    ADD CONSTRAINT "el_progress_assignment_id_slide_id_key" UNIQUE ("assignment_id", "slide_id");



ALTER TABLE ONLY "public"."el_progress"
    ADD CONSTRAINT "el_progress_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."el_quiz_options"
    ADD CONSTRAINT "el_quiz_options_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."el_quiz_questions"
    ADD CONSTRAINT "el_quiz_questions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."el_scenario_branches"
    ADD CONSTRAINT "el_scenario_branches_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."el_slides"
    ADD CONSTRAINT "el_slides_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."employee_approvers"
    ADD CONSTRAINT "employee_approvers_unique_role" UNIQUE ("tenant_id", "employee_id", "approver_id", "approver_role");



ALTER TABLE ONLY "public"."employee_career_goals"
    ADD CONSTRAINT "employee_career_goals_employee_id_target_skill_id_key" UNIQUE ("employee_id", "target_skill_id");



ALTER TABLE ONLY "public"."employee_career_goals"
    ADD CONSTRAINT "employee_career_goals_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."employee_recommended_courses"
    ADD CONSTRAINT "employee_recommended_courses_employee_id_course_id_key" UNIQUE ("employee_id", "course_id");



ALTER TABLE ONLY "public"."employee_recommended_courses"
    ADD CONSTRAINT "employee_recommended_courses_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."employee_skill_assignments"
    ADD CONSTRAINT "employee_skill_assignments_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."employee_skill_level_achievements"
    ADD CONSTRAINT "employee_skill_level_achievem_employee_id_skill_level_id_co_key" UNIQUE ("employee_id", "skill_level_id", "course_id");



ALTER TABLE ONLY "public"."employee_skill_level_achievements"
    ADD CONSTRAINT "employee_skill_level_achievements_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."employee_skill_requirement_history"
    ADD CONSTRAINT "employee_skill_requirement_history_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."employee_skill_requirement_selections"
    ADD CONSTRAINT "employee_skill_requirement_selec_employee_id_requirement_id_key" UNIQUE ("employee_id", "requirement_id");



ALTER TABLE ONLY "public"."employee_skill_requirement_selections"
    ADD CONSTRAINT "employee_skill_requirement_selections_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."employee_skill_self_evaluations"
    ADD CONSTRAINT "employee_skill_self_evaluations_employee_id_requirement_id_key" UNIQUE ("employee_id", "requirement_id");



ALTER TABLE ONLY "public"."employee_skill_self_evaluations"
    ADD CONSTRAINT "employee_skill_self_evaluations_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."employee_training_plans"
    ADD CONSTRAINT "employee_training_plans_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."evaluation_flow_logs"
    ADD CONSTRAINT "evaluation_flow_logs_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."evaluation_goals"
    ADD CONSTRAINT "evaluation_goals_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."evaluation_reminders"
    ADD CONSTRAINT "evaluation_reminders_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."evaluation_sheets"
    ADD CONSTRAINT "evaluation_sheets_employee_id_period_id_key" UNIQUE ("employee_id", "period_id");
...
ALTER TABLE ONLY "public"."global_evaluation_template_items"
    ADD CONSTRAINT "global_evaluation_template_items_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."global_evaluation_templates"
    ADD CONSTRAINT "global_evaluation_templates_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."global_skill_level_sets"
    ADD CONSTRAINT "global_skill_level_sets_name_key" UNIQUE ("name");



ALTER TABLE ONLY "public"."global_skill_level_sets"
    ADD CONSTRAINT "global_skill_level_sets_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."global_skill_levels"
    ADD CONSTRAINT "global_skill_levels_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."grade_evaluation_criteria"
    ADD CONSTRAINT "grade_evaluation_criteria_item_id_grade_code_key" UNIQUE ("item_id", "grade_code");



ALTER TABLE ONLY "public"."grade_evaluation_criteria"
    ADD CONSTRAINT "grade_evaluation_criteria_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."lifecycle_instances"
    ADD CONSTRAINT "lifecycle_instances_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."lifecycle_task_templates"
    ADD CONSTRAINT "lifecycle_task_templates_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."myou_companies"
    ADD CONSTRAINT "myou_companies_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."one_on_one_sessions"
    ADD CONSTRAINT "one_on_one_sessions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."one_on_one_theme_templates"
    ADD CONSTRAINT "one_on_one_theme_templates_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."project_simulations"
    ADD CONSTRAINT "project_simulations_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."questionnaire_periods"
    ADD CONSTRAINT "questionnaire_periods_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."simulation_assigned_members"
    ADD CONSTRAINT "simulation_assigned_members_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."simulation_assigned_members"
    ADD CONSTRAINT "simulation_assigned_members_simulation_id_position_id_key" UNIQUE ("simulation_id", "position_id");



ALTER TABLE ONLY "public"."simulation_position_requirements"
    ADD CONSTRAINT "simulation_position_requirements_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."employee_approvers"
    ADD CONSTRAINT "skill_approvers_tenant_id_employee_id_approver_id_key" UNIQUE ("tenant_id", "employee_id", "approver_id");



ALTER TABLE ONLY "public"."skill_consultations"
    ADD CONSTRAINT "skill_consultations_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."skill_feedback_comments"
    ADD CONSTRAINT "skill_feedback_comments_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."skill_growth_milestones"
    ADD CONSTRAINT "skill_growth_milestones_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."skill_map_drafts"
    ADD CONSTRAINT "skill_map_drafts_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."skill_requirement_applications"
    ADD CONSTRAINT "skill_requirement_applications_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."skill_role_applications"
    ADD CONSTRAINT "skill_role_applications_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."stress_check_period_divisions"
    ADD CONSTRAINT "stress_check_period_divisions_period_id_division_id_key" UNIQUE ("period_id", "division_id");



ALTER TABLE ONLY "public"."stress_check_period_divisions"
    ADD CONSTRAINT "stress_check_period_divisions_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."succession_candidates"
    ADD CONSTRAINT "succession_candidates_position_id_employee_id_key" UNIQUE ("position_id", "employee_id");



ALTER TABLE ONLY "public"."succession_positions"
    ADD CONSTRAINT "succession_positions_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."tenant_contracts"
    ADD CONSTRAINT "tenant_contracts_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."tenant_contracts"
    ADD CONSTRAINT "tenant_contracts_stripe_payment_intent_id_key" UNIQUE ("stripe_payment_intent_id");
...
ALTER TABLE ONLY "public"."tenant_skill_level_sets"
    ADD CONSTRAINT "tenant_skill_level_sets_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."tenant_skill_level_sets"
    ADD CONSTRAINT "tenant_skill_level_sets_tenant_name_key" UNIQUE ("tenant_id", "name");
...
ALTER TABLE ONLY "public"."tenant_stress_settings"
    ADD CONSTRAINT "tenant_stress_settings_pkey" PRIMARY KEY ("tenant_id");
...
ALTER TABLE ONLY "public"."training_plan_template_courses"
    ADD CONSTRAINT "training_plan_template_courses_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."training_plan_template_courses"
    ADD CONSTRAINT "training_plan_template_courses_template_id_course_id_key" UNIQUE ("template_id", "course_id");



ALTER TABLE ONLY "public"."training_plan_templates"
    ADD CONSTRAINT "training_plan_templates_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."turnover_risk_action_logs"
    ADD CONSTRAINT "turnover_risk_action_logs_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."turnover_risk_scores"
    ADD CONSTRAINT "turnover_risk_scores_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "candidates_assigned_to_idx" ON "public"."candidates" USING "btree" ("assigned_to");



CREATE INDEX "candidates_last_action_at_idx" ON "public"."candidates" USING "btree" ("last_action_at");
...
CREATE INDEX "candidates_tenant_stage_idx" ON "public"."candidates" USING "btree" ("tenant_id", "stage");



CREATE INDEX "el_course_requirement_mappings_tenant_id_course_id_idx" ON "public"."el_course_requirement_mappings" USING "btree" ("tenant_id", "course_id");



CREATE INDEX "el_course_requirement_mappings_tenant_id_requirement_id_idx" ON "public"."el_course_requirement_mappings" USING "btree" ("tenant_id", "requirement_id");



CREATE INDEX "el_course_skill_level_mappings_tenant_id_course_id_idx" ON "public"."el_course_skill_level_mappings" USING "btree" ("tenant_id", "course_id");



CREATE INDEX "el_course_skill_level_mappings_tenant_id_skill_level_id_idx" ON "public"."el_course_skill_level_mappings" USING "btree" ("tenant_id", "skill_level_id");



CREATE INDEX "employee_career_goals_tenant_id_employee_id_idx" ON "public"."employee_career_goals" USING "btree" ("tenant_id", "employee_id");



CREATE INDEX "employee_recommended_courses_tenant_id_employee_id_idx" ON "public"."employee_recommended_courses" USING "btree" ("tenant_id", "employee_id");



CREATE INDEX "employee_recommended_courses_tenant_id_recommender_id_idx" ON "public"."employee_recommended_courses" USING "btree" ("tenant_id", "recommender_id");



CREATE INDEX "employee_skill_assignments_tenant_id_employee_id_idx" ON "public"."employee_skill_assignments" USING "btree" ("tenant_id", "employee_id");



CREATE INDEX "employee_skill_assignments_tenant_id_skill_id_idx" ON "public"."employee_skill_assignments" USING "btree" ("tenant_id", "skill_id");



CREATE INDEX "employee_skill_level_achievements_tenant_id_employee_id_idx" ON "public"."employee_skill_level_achievements" USING "btree" ("tenant_id", "employee_id");



CREATE INDEX "employee_skill_level_achievements_tenant_id_skill_level_id_idx" ON "public"."employee_skill_level_achievements" USING "btree" ("tenant_id", "skill_level_id");



CREATE INDEX "employee_skill_requirement_hi_tenant_id_employee_id_recorde_idx" ON "public"."employee_skill_requirement_history" USING "btree" ("tenant_id", "employee_id", "recorded_at");



CREATE INDEX "employee_skill_requirement_selecti_tenant_id_requirement_id_idx" ON "public"."employee_skill_requirement_selections" USING "btree" ("tenant_id", "requirement_id");



CREATE INDEX "employee_skill_requirement_selections_tenant_id_employee_id_idx" ON "public"."employee_skill_requirement_selections" USING "btree" ("tenant_id", "employee_id");



CREATE INDEX "employee_skill_self_evaluations_tenant_id_employee_id_idx" ON "public"."employee_skill_self_evaluations" USING "btree" ("tenant_id", "employee_id");



CREATE INDEX "employee_skill_self_evaluations_tenant_id_requirement_id_idx" ON "public"."employee_skill_self_evaluations" USING "btree" ("tenant_id", "requirement_id");



CREATE INDEX "global_skill_levels_skill_level_set_id_idx" ON "public"."global_skill_levels" USING "btree" ("skill_level_set_id");
...
CREATE INDEX "idx_dea_division" ON "public"."division_establishment_anchors" USING "btree" ("division_id");



CREATE INDEX "idx_dea_establishment" ON "public"."division_establishment_anchors" USING "btree" ("division_establishment_id");



CREATE INDEX "idx_dea_tenant" ON "public"."division_establishment_anchors" USING "btree" ("tenant_id");



CREATE INDEX "idx_division_establishments_tenant" ON "public"."division_establishments" USING "btree" ("tenant_id");
...
CREATE INDEX "idx_el_assignments_course_id" ON "public"."el_assignments" USING "btree" ("course_id");



CREATE INDEX "idx_el_assignments_employee_id" ON "public"."el_assignments" USING "btree" ("employee_id");



CREATE INDEX "idx_el_assignments_tenant_employee" ON "public"."el_assignments" USING "btree" ("tenant_id", "employee_id");



CREATE INDEX "idx_el_checklist_completions_assignment_id" ON "public"."el_checklist_completions" USING "btree" ("assignment_id");



CREATE INDEX "idx_el_checklist_completions_tenant_id" ON "public"."el_checklist_completions" USING "btree" ("tenant_id");



CREATE INDEX "idx_el_checklist_items_slide_id" ON "public"."el_checklist_items" USING "btree" ("slide_id", "item_order");



CREATE INDEX "idx_el_courses_course_type" ON "public"."el_courses" USING "btree" ("course_type");



CREATE INDEX "idx_el_courses_status" ON "public"."el_courses" USING "btree" ("status");



CREATE INDEX "idx_el_courses_tenant_id" ON "public"."el_courses" USING "btree" ("tenant_id");



CREATE INDEX "idx_el_progress_assignment_id" ON "public"."el_progress" USING "btree" ("assignment_id");



CREATE INDEX "idx_el_progress_tenant_id" ON "public"."el_progress" USING "btree" ("tenant_id");



CREATE INDEX "idx_el_quiz_options_question_id" ON "public"."el_quiz_options" USING "btree" ("question_id");



CREATE INDEX "idx_el_quiz_questions_slide_id" ON "public"."el_quiz_questions" USING "btree" ("slide_id");



CREATE INDEX "idx_el_scenario_branches_slide_id" ON "public"."el_scenario_branches" USING "btree" ("slide_id", "branch_order");



CREATE INDEX "idx_el_slides_course_id" ON "public"."el_slides" USING "btree" ("course_id", "slide_order");



CREATE INDEX "idx_employee_qualifications_employee" ON "public"."employee_qualifications" USING "btree" ("employee_id");



CREATE INDEX "idx_employee_qualifications_expiry" ON "public"."employee_qualifications" USING "btree" ("expiry_date");



CREATE INDEX "idx_employee_qualifications_tenant" ON "public"."employee_qualifications" USING "btree" ("tenant_id");



CREATE INDEX "idx_employee_training_plans_tenant_employee" ON "public"."employee_training_plans" USING "btree" ("tenant_id", "employee_id", "created_at" DESC);



CREATE INDEX "idx_eval_flow_logs_sheet_id" ON "public"."evaluation_flow_logs" USING "btree" ("sheet_id");



CREATE INDEX "idx_eval_goals_sheet_id" ON "public"."evaluation_goals" USING "btree" ("sheet_id");



CREATE INDEX "idx_eval_reminders_period_id" ON "public"."evaluation_reminders" USING "btree" ("period_id");



CREATE INDEX "idx_eval_reminders_sheet_id" ON "public"."evaluation_reminders" USING "btree" ("sheet_id");



CREATE INDEX "idx_eval_scores_sheet_id" ON "public"."evaluation_scores" USING "btree" ("sheet_id");



CREATE INDEX "idx_eval_sheets_confirmer" ON "public"."evaluation_sheets" USING "btree" ("confirmer_id");



CREATE INDEX "idx_eval_sheets_employee_period" ON "public"."evaluation_sheets" USING "btree" ("employee_id", "period_id");



CREATE INDEX "idx_eval_sheets_primary" ON "public"."evaluation_sheets" USING "btree" ("primary_evaluator_id");



CREATE INDEX "idx_eval_sheets_secondary" ON "public"."evaluation_sheets" USING "btree" ("secondary_evaluator_id");



CREATE INDEX "idx_eval_template_items_template_id" ON "public"."evaluation_template_items" USING "btree" ("template_id");



CREATE INDEX "idx_global_eval_template_items_template_id" ON "public"."global_evaluation_template_items" USING "btree" ("template_id");
...
CREATE INDEX "idx_lifecycle_instances_employee" ON "public"."lifecycle_instances" USING "btree" ("tenant_id", "employee_id");



CREATE INDEX "idx_lifecycle_instances_tenant_type" ON "public"."lifecycle_instances" USING "btree" ("tenant_id", "lifecycle_type", "created_at" DESC);



CREATE INDEX "idx_lifecycle_task_templates_tenant" ON "public"."lifecycle_task_templates" USING "btree" ("tenant_id", "lifecycle_type", "sort_order");



CREATE INDEX "idx_lifecycle_tasks_instance" ON "public"."lifecycle_tasks" USING "btree" ("instance_id", "sort_order");



CREATE INDEX "idx_lifecycle_tasks_tenant_assignee" ON "public"."lifecycle_tasks" USING "btree" ("tenant_id", "assignee_id");
...
CREATE INDEX "idx_one_on_one_tenant_employee" ON "public"."one_on_one_sessions" USING "btree" ("tenant_id", "employee_id", "conducted_at" DESC);



CREATE INDEX "idx_one_on_one_tenant_manager" ON "public"."one_on_one_sessions" USING "btree" ("tenant_id", "manager_id", "conducted_at" DESC);
...
CREATE INDEX "idx_period_divisions_division" ON "public"."stress_check_period_divisions" USING "btree" ("division_id");



CREATE INDEX "idx_period_divisions_period" ON "public"."stress_check_period_divisions" USING "btree" ("period_id");



CREATE INDEX "idx_period_divisions_tenant" ON "public"."stress_check_period_divisions" USING "btree" ("tenant_id");



CREATE INDEX "idx_periods_questionnaire_id" ON "public"."questionnaire_periods" USING "btree" ("questionnaire_id");



CREATE INDEX "idx_periods_start_date" ON "public"."questionnaire_periods" USING "btree" ("start_date");
...
CREATE INDEX "idx_qualifications_tenant" ON "public"."qualifications" USING "btree" ("tenant_id");
...
CREATE INDEX "idx_sc_periods_establishment" ON "public"."stress_check_periods" USING "btree" ("tenant_id", "division_establishment_id");
...
CREATE INDEX "idx_skill_consultations_tenant_employee" ON "public"."skill_consultations" USING "btree" ("tenant_id", "employee_id");



CREATE INDEX "idx_skill_consultations_tenant_manager" ON "public"."skill_consultations" USING "btree" ("tenant_id", "manager_id");



CREATE INDEX "idx_skill_growth_milestones_tenant_employee" ON "public"."skill_growth_milestones" USING "btree" ("tenant_id", "employee_id");



CREATE INDEX "idx_skill_map_drafts_tenant" ON "public"."skill_map_drafts" USING "btree" ("tenant_id");
...
CREATE INDEX "idx_succession_candidates_employee" ON "public"."succession_candidates" USING "btree" ("employee_id");



CREATE INDEX "idx_succession_candidates_position" ON "public"."succession_candidates" USING "btree" ("position_id");



CREATE INDEX "idx_succession_candidates_tenant_emp" ON "public"."succession_candidates" USING "btree" ("tenant_id", "employee_id");



CREATE INDEX "idx_succession_positions_division" ON "public"."succession_positions" USING "btree" ("division_id");



CREATE INDEX "idx_succession_positions_holder" ON "public"."succession_positions" USING "btree" ("current_holder_id");



CREATE INDEX "idx_succession_positions_tenant" ON "public"."succession_positions" USING "btree" ("tenant_id", "sort_order");
...
CREATE INDEX "idx_tenant_contracts_applicant_email" ON "public"."tenant_contracts" USING "btree" ("applicant_email");



CREATE INDEX "idx_tenant_contracts_payment_status" ON "public"."tenant_contracts" USING "btree" ("payment_status");



CREATE INDEX "idx_tenant_contracts_tenant_id" ON "public"."tenant_contracts" USING "btree" ("tenant_id");



CREATE INDEX "idx_theme_templates_tenant" ON "public"."one_on_one_theme_templates" USING "btree" ("tenant_id", "sort_order");
...
CREATE INDEX "idx_training_plan_template_courses_template" ON "public"."training_plan_template_courses" USING "btree" ("template_id", "sort_order");



CREATE INDEX "idx_training_plan_templates_tenant" ON "public"."training_plan_templates" USING "btree" ("tenant_id", "sort_order");



CREATE INDEX "idx_turnover_action_employee" ON "public"."turnover_risk_action_logs" USING "btree" ("tenant_id", "employee_id", "actioned_at" DESC);



CREATE INDEX "idx_turnover_risk_level" ON "public"."turnover_risk_scores" USING "btree" ("tenant_id", "risk_level", "calculated_at" DESC);



CREATE INDEX "idx_turnover_risk_tenant_emp" ON "public"."turnover_risk_scores" USING "btree" ("tenant_id", "employee_id", "calculated_at" DESC);
...
CREATE INDEX "idx_wip_source_establishment" ON "public"."workplace_improvement_plans" USING "btree" ("source_division_establishment_id");
...
CREATE INDEX "project_simulations_tenant_id_idx" ON "public"."project_simulations" USING "btree" ("tenant_id");
...
CREATE INDEX "simulation_assigned_members_tenant_id_simulation_id_employe_idx" ON "public"."simulation_assigned_members" USING "btree" ("tenant_id", "simulation_id", "employee_id");



CREATE INDEX "simulation_position_requirements_tenant_id_position_id_idx" ON "public"."simulation_position_requirements" USING "btree" ("tenant_id", "position_id");



CREATE INDEX "simulation_positions_tenant_id_simulation_id_idx" ON "public"."simulation_positions" USING "btree" ("tenant_id", "simulation_id");



CREATE INDEX "skill_feedback_comments_tenant_id_receiver_employee_id_idx" ON "public"."skill_feedback_comments" USING "btree" ("tenant_id", "receiver_employee_id");



CREATE INDEX "skill_feedback_comments_tenant_id_sender_employee_id_idx" ON "public"."skill_feedback_comments" USING "btree" ("tenant_id", "sender_employee_id");



CREATE INDEX "skill_levels_skill_level_set_id_idx" ON "public"."skill_levels" USING "btree" ("skill_level_set_id");



CREATE INDEX "skill_requirements_tenant_id_skill_id_idx" ON "public"."skill_requirements" USING "btree" ("tenant_id", "skill_id");



CREATE UNIQUE INDEX "stress_check_periods_one_active_per_establishment" ON "public"."stress_check_periods" USING "btree" ("tenant_id", "division_establishment_id") WHERE (("status" = 'active'::"text") AND ("division_establishment_id" IS NOT NULL));



CREATE UNIQUE INDEX "stress_check_periods_unique_establishment_fiscal" ON "public"."stress_check_periods" USING "btree" ("tenant_id", "division_establishment_id", "fiscal_year") WHERE ("division_establishment_id" IS NOT NULL);
...
CREATE INDEX "tenant_skill_level_sets_tenant_id_idx" ON "public"."tenant_skill_level_sets" USING "btree" ("tenant_id");



CREATE UNIQUE INDEX "uniq_assignment_period_employee" ON "public"."questionnaire_assignments" USING "btree" ("period_id", "employee_id") WHERE ("period_id" IS NOT NULL);



CREATE UNIQUE INDEX "uniq_response_period_employee" ON "public"."questionnaire_responses" USING "btree" ("period_id", "employee_id") WHERE ("period_id" IS NOT NULL);
...
CREATE OR REPLACE TRIGGER "candidates_update_timestamps" BEFORE UPDATE ON "public"."candidates" FOR EACH ROW EXECUTE FUNCTION "public"."update_candidate_timestamps"();
...
CREATE OR REPLACE TRIGGER "set_el_courses_updated_at" BEFORE UPDATE ON "public"."el_courses" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_el_slides_updated_at" BEFORE UPDATE ON "public"."el_slides" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "trg_division_establishments_updated_at" BEFORE UPDATE ON "public"."division_establishments" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "trg_tenant_stress_settings_updated_at" BEFORE UPDATE ON "public"."tenant_stress_settings" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
ALTER TABLE ONLY "public"."candidates"
    ADD CONSTRAINT "candidates_assigned_to_fkey" FOREIGN KEY ("assigned_to") REFERENCES "public"."employees"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."candidates"
    ADD CONSTRAINT "candidates_job_posting_id_fkey" FOREIGN KEY ("job_posting_id") REFERENCES "public"."job_postings"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."division_establishment_anchors"
    ADD CONSTRAINT "division_establishment_anchors_division_establishment_id_fkey" FOREIGN KEY ("division_establishment_id") REFERENCES "public"."division_establishments"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."division_establishment_anchors"
    ADD CONSTRAINT "division_establishment_anchors_division_id_fkey" FOREIGN KEY ("division_id") REFERENCES "public"."divisions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."division_establishment_anchors"
    ADD CONSTRAINT "division_establishment_anchors_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."division_establishments"
    ADD CONSTRAINT "division_establishments_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."el_assignments"
    ADD CONSTRAINT "el_assignments_assigned_by_employee_id_fkey" FOREIGN KEY ("assigned_by_employee_id") REFERENCES "public"."employees"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."el_assignments"
    ADD CONSTRAINT "el_assignments_course_id_fkey" FOREIGN KEY ("course_id") REFERENCES "public"."el_courses"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_assignments"
    ADD CONSTRAINT "el_assignments_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_assignments"
    ADD CONSTRAINT "el_assignments_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_checklist_completions"
    ADD CONSTRAINT "el_checklist_completions_assignment_id_fkey" FOREIGN KEY ("assignment_id") REFERENCES "public"."el_assignments"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_checklist_completions"
    ADD CONSTRAINT "el_checklist_completions_checklist_item_id_fkey" FOREIGN KEY ("checklist_item_id") REFERENCES "public"."el_checklist_items"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_checklist_completions"
    ADD CONSTRAINT "el_checklist_completions_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_checklist_completions"
    ADD CONSTRAINT "el_checklist_completions_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_checklist_items"
    ADD CONSTRAINT "el_checklist_items_slide_id_fkey" FOREIGN KEY ("slide_id") REFERENCES "public"."el_slides"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_course_requirement_mappings"
    ADD CONSTRAINT "el_course_requirement_mappings_course_id_fkey" FOREIGN KEY ("course_id") REFERENCES "public"."el_courses"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_course_requirement_mappings"
    ADD CONSTRAINT "el_course_requirement_mappings_requirement_id_fkey" FOREIGN KEY ("requirement_id") REFERENCES "public"."skill_requirements"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_course_requirement_mappings"
    ADD CONSTRAINT "el_course_requirement_mappings_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_course_skill_level_mappings"
    ADD CONSTRAINT "el_course_skill_level_mappings_course_id_fkey" FOREIGN KEY ("course_id") REFERENCES "public"."el_courses"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_course_skill_level_mappings"
    ADD CONSTRAINT "el_course_skill_level_mappings_skill_level_id_fkey" FOREIGN KEY ("skill_level_id") REFERENCES "public"."skill_levels"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_course_skill_level_mappings"
    ADD CONSTRAINT "el_course_skill_level_mappings_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_courses"
    ADD CONSTRAINT "el_courses_created_by_employee_id_fkey" FOREIGN KEY ("created_by_employee_id") REFERENCES "public"."employees"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."el_courses"
    ADD CONSTRAINT "el_courses_original_course_id_fkey" FOREIGN KEY ("original_course_id") REFERENCES "public"."el_courses"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."el_courses"
    ADD CONSTRAINT "el_courses_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_progress"
    ADD CONSTRAINT "el_progress_assignment_id_fkey" FOREIGN KEY ("assignment_id") REFERENCES "public"."el_assignments"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_progress"
    ADD CONSTRAINT "el_progress_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_progress"
    ADD CONSTRAINT "el_progress_scenario_branch_id_fkey" FOREIGN KEY ("scenario_branch_id") REFERENCES "public"."el_scenario_branches"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."el_progress"
    ADD CONSTRAINT "el_progress_slide_id_fkey" FOREIGN KEY ("slide_id") REFERENCES "public"."el_slides"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_progress"
    ADD CONSTRAINT "el_progress_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_quiz_options"
    ADD CONSTRAINT "el_quiz_options_question_id_fkey" FOREIGN KEY ("question_id") REFERENCES "public"."el_quiz_questions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_quiz_questions"
    ADD CONSTRAINT "el_quiz_questions_slide_id_fkey" FOREIGN KEY ("slide_id") REFERENCES "public"."el_slides"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_scenario_branches"
    ADD CONSTRAINT "el_scenario_branches_slide_id_fkey" FOREIGN KEY ("slide_id") REFERENCES "public"."el_slides"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."el_slides"
    ADD CONSTRAINT "el_slides_course_id_fkey" FOREIGN KEY ("course_id") REFERENCES "public"."el_courses"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_approvers"
    ADD CONSTRAINT "employee_approvers_approver_id_fkey" FOREIGN KEY ("approver_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."employee_approvers"
    ADD CONSTRAINT "employee_approvers_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_career_goals"
    ADD CONSTRAINT "employee_career_goals_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_career_goals"
    ADD CONSTRAINT "employee_career_goals_proposed_by_fkey" FOREIGN KEY ("proposed_by") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."employee_career_goals"
    ADD CONSTRAINT "employee_career_goals_target_skill_id_fkey" FOREIGN KEY ("target_skill_id") REFERENCES "public"."tenant_skills"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_career_goals"
    ADD CONSTRAINT "employee_career_goals_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."employee_qualifications"
    ADD CONSTRAINT "employee_qualifications_qualification_id_fkey" FOREIGN KEY ("qualification_id") REFERENCES "public"."qualifications"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_qualifications"
    ADD CONSTRAINT "employee_qualifications_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_recommended_courses"
    ADD CONSTRAINT "employee_recommended_courses_course_id_fkey" FOREIGN KEY ("course_id") REFERENCES "public"."el_courses"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_recommended_courses"
    ADD CONSTRAINT "employee_recommended_courses_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_recommended_courses"
    ADD CONSTRAINT "employee_recommended_courses_recommender_id_fkey" FOREIGN KEY ("recommender_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_recommended_courses"
    ADD CONSTRAINT "employee_recommended_courses_requirement_id_fkey" FOREIGN KEY ("requirement_id") REFERENCES "public"."skill_requirements"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_recommended_courses"
    ADD CONSTRAINT "employee_recommended_courses_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_assignments"
    ADD CONSTRAINT "employee_skill_assignments_assigned_by_fkey" FOREIGN KEY ("assigned_by") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."employee_skill_assignments"
    ADD CONSTRAINT "employee_skill_assignments_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_assignments"
    ADD CONSTRAINT "employee_skill_assignments_skill_id_fkey" FOREIGN KEY ("skill_id") REFERENCES "public"."tenant_skills"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_assignments"
    ADD CONSTRAINT "employee_skill_assignments_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_level_achievements"
    ADD CONSTRAINT "employee_skill_level_achievements_course_id_fkey" FOREIGN KEY ("course_id") REFERENCES "public"."el_courses"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_level_achievements"
    ADD CONSTRAINT "employee_skill_level_achievements_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_level_achievements"
    ADD CONSTRAINT "employee_skill_level_achievements_skill_level_id_fkey" FOREIGN KEY ("skill_level_id") REFERENCES "public"."skill_levels"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_level_achievements"
    ADD CONSTRAINT "employee_skill_level_achievements_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_requirement_history"
    ADD CONSTRAINT "employee_skill_requirement_history_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_requirement_history"
    ADD CONSTRAINT "employee_skill_requirement_history_skill_id_fkey" FOREIGN KEY ("skill_id") REFERENCES "public"."tenant_skills"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_requirement_history"
    ADD CONSTRAINT "employee_skill_requirement_history_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_requirement_selections"
    ADD CONSTRAINT "employee_skill_requirement_selections_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_requirement_selections"
    ADD CONSTRAINT "employee_skill_requirement_selections_requirement_id_fkey" FOREIGN KEY ("requirement_id") REFERENCES "public"."skill_requirements"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_requirement_selections"
    ADD CONSTRAINT "employee_skill_requirement_selections_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_self_evaluations"
    ADD CONSTRAINT "employee_skill_self_evaluations_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_self_evaluations"
    ADD CONSTRAINT "employee_skill_self_evaluations_requirement_id_fkey" FOREIGN KEY ("requirement_id") REFERENCES "public"."skill_requirements"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_skill_self_evaluations"
    ADD CONSTRAINT "employee_skill_self_evaluations_self_level_id_fkey" FOREIGN KEY ("self_level_id") REFERENCES "public"."skill_levels"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."employee_skill_self_evaluations"
    ADD CONSTRAINT "employee_skill_self_evaluations_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."employee_training_plans"
    ADD CONSTRAINT "employee_training_plans_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."employee_training_plans"
    ADD CONSTRAINT "employee_training_plans_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."employee_training_plans"
    ADD CONSTRAINT "employee_training_plans_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "public"."training_plan_templates"("id");



ALTER TABLE ONLY "public"."employee_training_plans"
    ADD CONSTRAINT "employee_training_plans_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");
...
ALTER TABLE ONLY "public"."evaluation_flow_logs"
    ADD CONSTRAINT "evaluation_flow_logs_changed_by_fkey" FOREIGN KEY ("changed_by") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."evaluation_flow_logs"
    ADD CONSTRAINT "evaluation_flow_logs_sheet_id_fkey" FOREIGN KEY ("sheet_id") REFERENCES "public"."evaluation_sheets"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."evaluation_flow_logs"
    ADD CONSTRAINT "evaluation_flow_logs_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."evaluation_goals"
    ADD CONSTRAINT "evaluation_goals_approved_by_fkey" FOREIGN KEY ("approved_by") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."evaluation_goals"
    ADD CONSTRAINT "evaluation_goals_item_id_fkey" FOREIGN KEY ("item_id") REFERENCES "public"."evaluation_template_items"("id");



ALTER TABLE ONLY "public"."evaluation_goals"
    ADD CONSTRAINT "evaluation_goals_sheet_id_fkey" FOREIGN KEY ("sheet_id") REFERENCES "public"."evaluation_sheets"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."evaluation_goals"
    ADD CONSTRAINT "evaluation_goals_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."evaluation_periods"
    ADD CONSTRAINT "evaluation_periods_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."evaluation_reminders"
    ADD CONSTRAINT "evaluation_reminders_period_id_fkey" FOREIGN KEY ("period_id") REFERENCES "public"."evaluation_periods"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."evaluation_reminders"
    ADD CONSTRAINT "evaluation_reminders_sent_by_fkey" FOREIGN KEY ("sent_by") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."evaluation_reminders"
    ADD CONSTRAINT "evaluation_reminders_sheet_id_fkey" FOREIGN KEY ("sheet_id") REFERENCES "public"."evaluation_sheets"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."evaluation_reminders"
    ADD CONSTRAINT "evaluation_reminders_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."evaluation_scores"
    ADD CONSTRAINT "evaluation_scores_evaluator_id_fkey" FOREIGN KEY ("evaluator_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."evaluation_scores"
    ADD CONSTRAINT "evaluation_scores_goal_id_fkey" FOREIGN KEY ("goal_id") REFERENCES "public"."evaluation_goals"("id");



ALTER TABLE ONLY "public"."evaluation_scores"
    ADD CONSTRAINT "evaluation_scores_item_id_fkey" FOREIGN KEY ("item_id") REFERENCES "public"."evaluation_template_items"("id");



ALTER TABLE ONLY "public"."evaluation_scores"
    ADD CONSTRAINT "evaluation_scores_sheet_id_fkey" FOREIGN KEY ("sheet_id") REFERENCES "public"."evaluation_sheets"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."evaluation_scores"
    ADD CONSTRAINT "evaluation_scores_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."evaluation_sheets"
    ADD CONSTRAINT "evaluation_sheets_confirmer_id_fkey" FOREIGN KEY ("confirmer_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."evaluation_sheets"
    ADD CONSTRAINT "evaluation_sheets_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."evaluation_sheets"
    ADD CONSTRAINT "evaluation_sheets_period_id_fkey" FOREIGN KEY ("period_id") REFERENCES "public"."evaluation_periods"("id");



ALTER TABLE ONLY "public"."evaluation_sheets"
    ADD CONSTRAINT "evaluation_sheets_primary_evaluator_id_fkey" FOREIGN KEY ("primary_evaluator_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."evaluation_sheets"
    ADD CONSTRAINT "evaluation_sheets_secondary_evaluator_id_fkey" FOREIGN KEY ("secondary_evaluator_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."evaluation_sheets"
    ADD CONSTRAINT "evaluation_sheets_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "public"."evaluation_templates"("id");



ALTER TABLE ONLY "public"."evaluation_sheets"
    ADD CONSTRAINT "evaluation_sheets_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."evaluation_template_items"
    ADD CONSTRAINT "evaluation_template_items_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "public"."evaluation_templates"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."evaluation_template_items"
    ADD CONSTRAINT "evaluation_template_items_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."evaluation_templates"
    ADD CONSTRAINT "evaluation_templates_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."evaluation_templates"
    ADD CONSTRAINT "evaluation_templates_global_template_id_fkey" FOREIGN KEY ("global_template_id") REFERENCES "public"."global_evaluation_templates"("id");



ALTER TABLE ONLY "public"."evaluation_templates"
    ADD CONSTRAINT "evaluation_templates_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."global_evaluation_template_items"
    ADD CONSTRAINT "global_evaluation_template_items_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "public"."global_evaluation_templates"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."global_skill_levels"
    ADD CONSTRAINT "global_skill_levels_skill_level_set_id_fkey" FOREIGN KEY ("skill_level_set_id") REFERENCES "public"."global_skill_level_sets"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."grade_evaluation_criteria"
    ADD CONSTRAINT "grade_evaluation_criteria_item_id_fkey" FOREIGN KEY ("item_id") REFERENCES "public"."evaluation_template_items"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."grade_evaluation_criteria"
    ADD CONSTRAINT "grade_evaluation_criteria_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");
...
ALTER TABLE ONLY "public"."lifecycle_instances"
    ADD CONSTRAINT "lifecycle_instances_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."lifecycle_instances"
    ADD CONSTRAINT "lifecycle_instances_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."lifecycle_instances"
    ADD CONSTRAINT "lifecycle_instances_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."lifecycle_task_templates"
    ADD CONSTRAINT "lifecycle_task_templates_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."lifecycle_tasks"
    ADD CONSTRAINT "lifecycle_tasks_assignee_id_fkey" FOREIGN KEY ("assignee_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."lifecycle_tasks"
    ADD CONSTRAINT "lifecycle_tasks_instance_id_fkey" FOREIGN KEY ("instance_id") REFERENCES "public"."lifecycle_instances"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."lifecycle_tasks"
    ADD CONSTRAINT "lifecycle_tasks_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");
...
ALTER TABLE ONLY "public"."myou_alert_logs"
    ADD CONSTRAINT "myou_alert_logs_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."myou_companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."myou_delivery_logs"
    ADD CONSTRAINT "myou_delivery_logs_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."myou_companies"("id");



ALTER TABLE ONLY "public"."myou_products"
    ADD CONSTRAINT "myou_products_current_company_id_fkey" FOREIGN KEY ("current_company_id") REFERENCES "public"."myou_companies"("id");



ALTER TABLE ONLY "public"."one_on_one_sessions"
    ADD CONSTRAINT "one_on_one_sessions_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."one_on_one_sessions"
    ADD CONSTRAINT "one_on_one_sessions_manager_id_fkey" FOREIGN KEY ("manager_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."one_on_one_sessions"
    ADD CONSTRAINT "one_on_one_sessions_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."one_on_one_theme_templates"
    ADD CONSTRAINT "one_on_one_theme_templates_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");
...
ALTER TABLE ONLY "public"."project_simulations"
    ADD CONSTRAINT "project_simulations_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."employees"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."project_simulations"
    ADD CONSTRAINT "project_simulations_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."qualifications"
    ADD CONSTRAINT "qualifications_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."questionnaire_assignments"
    ADD CONSTRAINT "questionnaire_assignments_period_id_fkey" FOREIGN KEY ("period_id") REFERENCES "public"."questionnaire_periods"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."questionnaire_periods"
    ADD CONSTRAINT "questionnaire_periods_questionnaire_id_fkey" FOREIGN KEY ("questionnaire_id") REFERENCES "public"."questionnaires"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."questionnaire_responses"
    ADD CONSTRAINT "questionnaire_responses_period_id_fkey" FOREIGN KEY ("period_id") REFERENCES "public"."questionnaire_periods"("id");
...
ALTER TABLE ONLY "public"."simulation_assigned_members"
    ADD CONSTRAINT "simulation_assigned_members_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."simulation_assigned_members"
    ADD CONSTRAINT "simulation_assigned_members_position_id_fkey" FOREIGN KEY ("position_id") REFERENCES "public"."simulation_positions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."simulation_assigned_members"
    ADD CONSTRAINT "simulation_assigned_members_simulation_id_fkey" FOREIGN KEY ("simulation_id") REFERENCES "public"."project_simulations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."simulation_assigned_members"
    ADD CONSTRAINT "simulation_assigned_members_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."simulation_position_requirements"
    ADD CONSTRAINT "simulation_position_requirements_position_id_fkey" FOREIGN KEY ("position_id") REFERENCES "public"."simulation_positions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."simulation_position_requirements"
    ADD CONSTRAINT "simulation_position_requirements_requirement_id_fkey" FOREIGN KEY ("requirement_id") REFERENCES "public"."skill_requirements"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."simulation_position_requirements"
    ADD CONSTRAINT "simulation_position_requirements_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."simulation_positions"
    ADD CONSTRAINT "simulation_positions_simulation_id_fkey" FOREIGN KEY ("simulation_id") REFERENCES "public"."project_simulations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."simulation_positions"
    ADD CONSTRAINT "simulation_positions_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_consultations"
    ADD CONSTRAINT "skill_consultations_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."skill_consultations"
    ADD CONSTRAINT "skill_consultations_manager_id_fkey" FOREIGN KEY ("manager_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."skill_consultations"
    ADD CONSTRAINT "skill_consultations_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."skill_feedback_comments"
    ADD CONSTRAINT "skill_feedback_comments_receiver_employee_id_fkey" FOREIGN KEY ("receiver_employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_feedback_comments"
    ADD CONSTRAINT "skill_feedback_comments_sender_employee_id_fkey" FOREIGN KEY ("sender_employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_feedback_comments"
    ADD CONSTRAINT "skill_feedback_comments_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_growth_milestones"
    ADD CONSTRAINT "skill_growth_milestones_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."skill_growth_milestones"
    ADD CONSTRAINT "skill_growth_milestones_proposed_by_fkey" FOREIGN KEY ("proposed_by") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."skill_growth_milestones"
    ADD CONSTRAINT "skill_growth_milestones_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."skill_levels"
    ADD CONSTRAINT "skill_levels_skill_level_set_id_fkey" FOREIGN KEY ("skill_level_set_id") REFERENCES "public"."tenant_skill_level_sets"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_levels"
    ADD CONSTRAINT "skill_levels_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_map_drafts"
    ADD CONSTRAINT "skill_map_drafts_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."skill_map_drafts"
    ADD CONSTRAINT "skill_map_drafts_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_requirement_applications"
    ADD CONSTRAINT "skill_requirement_applications_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_requirement_applications"
    ADD CONSTRAINT "skill_requirement_applications_hr_approved_by_fkey" FOREIGN KEY ("hr_approved_by") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."skill_requirement_applications"
    ADD CONSTRAINT "skill_requirement_applications_manager_approved_by_fkey" FOREIGN KEY ("manager_approved_by") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."skill_requirement_applications"
    ADD CONSTRAINT "skill_requirement_applications_requirement_id_fkey" FOREIGN KEY ("requirement_id") REFERENCES "public"."skill_requirements"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_requirement_applications"
    ADD CONSTRAINT "skill_requirement_applications_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_requirements"
    ADD CONSTRAINT "skill_requirements_level_id_fkey" FOREIGN KEY ("level_id") REFERENCES "public"."skill_levels"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."skill_requirements"
    ADD CONSTRAINT "skill_requirements_skill_id_fkey" FOREIGN KEY ("skill_id") REFERENCES "public"."tenant_skills"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_requirements"
    ADD CONSTRAINT "skill_requirements_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_role_applications"
    ADD CONSTRAINT "skill_role_applications_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_role_applications"
    ADD CONSTRAINT "skill_role_applications_hr_approved_by_fkey" FOREIGN KEY ("hr_approved_by") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."skill_role_applications"
    ADD CONSTRAINT "skill_role_applications_manager_approved_by_fkey" FOREIGN KEY ("manager_approved_by") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."skill_role_applications"
    ADD CONSTRAINT "skill_role_applications_skill_id_fkey" FOREIGN KEY ("skill_id") REFERENCES "public"."tenant_skills"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skill_role_applications"
    ADD CONSTRAINT "skill_role_applications_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."stress_check_period_divisions"
    ADD CONSTRAINT "stress_check_period_divisions_division_id_fkey" FOREIGN KEY ("division_id") REFERENCES "public"."divisions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."stress_check_period_divisions"
    ADD CONSTRAINT "stress_check_period_divisions_period_id_fkey" FOREIGN KEY ("period_id") REFERENCES "public"."stress_check_periods"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."stress_check_period_divisions"
    ADD CONSTRAINT "stress_check_period_divisions_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."stress_check_periods"
    ADD CONSTRAINT "stress_check_periods_division_establishment_id_fkey" FOREIGN KEY ("division_establishment_id") REFERENCES "public"."division_establishments"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."succession_candidates"
    ADD CONSTRAINT "succession_candidates_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."succession_candidates"
    ADD CONSTRAINT "succession_candidates_position_id_fkey" FOREIGN KEY ("position_id") REFERENCES "public"."succession_positions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."succession_candidates"
    ADD CONSTRAINT "succession_candidates_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."succession_positions"
    ADD CONSTRAINT "succession_positions_current_holder_id_fkey" FOREIGN KEY ("current_holder_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."succession_positions"
    ADD CONSTRAINT "succession_positions_division_id_fkey" FOREIGN KEY ("division_id") REFERENCES "public"."divisions"("id");



ALTER TABLE ONLY "public"."succession_positions"
    ADD CONSTRAINT "succession_positions_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."tenant_contracts"
    ADD CONSTRAINT "tenant_contracts_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."tenant_skill_level_sets"
    ADD CONSTRAINT "tenant_skill_level_sets_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."tenant_skills"
    ADD CONSTRAINT "tenant_skills_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."tenant_stress_settings"
    ADD CONSTRAINT "tenant_stress_settings_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."training_plan_template_courses"
    ADD CONSTRAINT "training_plan_template_courses_course_id_fkey" FOREIGN KEY ("course_id") REFERENCES "public"."el_courses"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."training_plan_template_courses"
    ADD CONSTRAINT "training_plan_template_courses_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "public"."training_plan_templates"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."training_plan_template_courses"
    ADD CONSTRAINT "training_plan_template_courses_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."training_plan_templates"
    ADD CONSTRAINT "training_plan_templates_skill_id_fkey" FOREIGN KEY ("skill_id") REFERENCES "public"."tenant_skills"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."training_plan_templates"
    ADD CONSTRAINT "training_plan_templates_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."turnover_risk_action_logs"
    ADD CONSTRAINT "turnover_risk_action_logs_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."turnover_risk_action_logs"
    ADD CONSTRAINT "turnover_risk_action_logs_logged_by_fkey" FOREIGN KEY ("logged_by") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."turnover_risk_action_logs"
    ADD CONSTRAINT "turnover_risk_action_logs_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");



ALTER TABLE ONLY "public"."turnover_risk_scores"
    ADD CONSTRAINT "turnover_risk_scores_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("id");



ALTER TABLE ONLY "public"."turnover_risk_scores"
    ADD CONSTRAINT "turnover_risk_scores_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");
...
ALTER TABLE ONLY "public"."workplace_improvement_plans"
    ADD CONSTRAINT "workplace_improvement_plans_source_division_establishment__fkey" FOREIGN KEY ("source_division_establishment_id") REFERENCES "public"."division_establishments"("id") ON DELETE SET NULL;
...
CREATE POLICY "Enable all for authenticated users" ON "public"."myou_alert_logs" TO "authenticated" USING (true);
...
CREATE POLICY "candidates_tenant_isolation" ON "public"."candidates" USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));
...
CREATE POLICY "division_establishment_anchors_delete_same_tenant" ON "public"."division_establishment_anchors" FOR DELETE USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "division_establishment_anchors_insert_same_tenant" ON "public"."division_establishment_anchors" FOR INSERT WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "division_establishment_anchors_select_same_tenant" ON "public"."division_establishment_anchors" FOR SELECT USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "division_establishment_anchors_update_same_tenant" ON "public"."division_establishment_anchors" FOR UPDATE USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));
...
CREATE POLICY "division_establishments_delete_same_tenant" ON "public"."division_establishments" FOR DELETE USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "division_establishments_insert_same_tenant" ON "public"."division_establishments" FOR INSERT WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "division_establishments_select_same_tenant" ON "public"."division_establishments" FOR SELECT USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "division_establishments_update_same_tenant" ON "public"."division_establishments" FOR UPDATE USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));
...
CREATE POLICY "el_assignments_tenant" ON "public"."el_assignments" USING (("tenant_id" = "public"."current_tenant_id"()));
...
CREATE POLICY "el_checklist_completions_tenant" ON "public"."el_checklist_completions" USING (("tenant_id" = "public"."current_tenant_id"()));
...
CREATE POLICY "el_checklist_items_all" ON "public"."el_checklist_items" USING ((EXISTS ( SELECT 1
   FROM ("public"."el_slides" "s"
     JOIN "public"."el_courses" "c" ON (("c"."id" = "s"."course_id")))
  WHERE (("s"."id" = "el_checklist_items"."slide_id") AND (("c"."tenant_id" = "public"."current_tenant_id"()) OR ("c"."tenant_id" IS NULL))))));
...
CREATE POLICY "el_courses_delete" ON "public"."el_courses" FOR DELETE USING ((("tenant_id" = "public"."current_tenant_id"()) OR (("tenant_id" IS NULL) AND ("public"."current_employee_app_role"() = 'developer'::"text"))));



CREATE POLICY "el_courses_insert" ON "public"."el_courses" FOR INSERT WITH CHECK ((("tenant_id" = "public"."current_tenant_id"()) OR (("tenant_id" IS NULL) AND ("public"."current_employee_app_role"() = 'developer'::"text"))));



CREATE POLICY "el_courses_select" ON "public"."el_courses" FOR SELECT USING ((("tenant_id" = "public"."current_tenant_id"()) OR ("tenant_id" IS NULL)));



CREATE POLICY "el_courses_update" ON "public"."el_courses" FOR UPDATE USING ((("tenant_id" = "public"."current_tenant_id"()) OR (("tenant_id" IS NULL) AND ("public"."current_employee_app_role"() = 'developer'::"text"))));
...
CREATE POLICY "el_progress_tenant" ON "public"."el_progress" USING (("tenant_id" = "public"."current_tenant_id"()));
...
CREATE POLICY "el_quiz_options_all" ON "public"."el_quiz_options" USING ((EXISTS ( SELECT 1
   FROM (("public"."el_quiz_questions" "q"
     JOIN "public"."el_slides" "s" ON (("s"."id" = "q"."slide_id")))
     JOIN "public"."el_courses" "c" ON (("c"."id" = "s"."course_id")))
  WHERE (("q"."id" = "el_quiz_options"."question_id") AND (("c"."tenant_id" = "public"."current_tenant_id"()) OR ("c"."tenant_id" IS NULL))))));
...
CREATE POLICY "el_quiz_questions_all" ON "public"."el_quiz_questions" USING ((EXISTS ( SELECT 1
   FROM ("public"."el_slides" "s"
     JOIN "public"."el_courses" "c" ON (("c"."id" = "s"."course_id")))
  WHERE (("s"."id" = "el_quiz_questions"."slide_id") AND (("c"."tenant_id" = "public"."current_tenant_id"()) OR ("c"."tenant_id" IS NULL))))));
...
CREATE POLICY "el_scenario_branches_all" ON "public"."el_scenario_branches" USING ((EXISTS ( SELECT 1
   FROM ("public"."el_slides" "s"
     JOIN "public"."el_courses" "c" ON (("c"."id" = "s"."course_id")))
  WHERE (("s"."id" = "el_scenario_branches"."slide_id") AND (("c"."tenant_id" = "public"."current_tenant_id"()) OR ("c"."tenant_id" IS NULL))))));
...
CREATE POLICY "el_slides_all" ON "public"."el_slides" USING ((EXISTS ( SELECT 1
   FROM "public"."el_courses" "c"
  WHERE (("c"."id" = "el_slides"."course_id") AND (("c"."tenant_id" = "public"."current_tenant_id"()) OR ("c"."tenant_id" IS NULL))))));
...
CREATE POLICY "employee_or_manager" ON "public"."skill_consultations" USING ((("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))) AND (("employee_id" = ( SELECT "employees"."id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))) OR ("manager_id" = ( SELECT "employees"."id"
   FROM "public"."employees"
...
CREATE POLICY "global_eval_template_items_select" ON "public"."global_evaluation_template_items" FOR SELECT USING (true);



CREATE POLICY "global_eval_templates_select" ON "public"."global_evaluation_templates" FOR SELECT USING (true);
...
CREATE POLICY "period_divisions_delete" ON "public"."stress_check_period_divisions" FOR DELETE TO "authenticated" USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "period_divisions_insert" ON "public"."stress_check_period_divisions" FOR INSERT TO "authenticated" WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "period_divisions_select" ON "public"."stress_check_period_divisions" FOR SELECT TO "authenticated" USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "periods_delete" ON "public"."questionnaire_periods" FOR DELETE TO "authenticated" USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "periods_insert" ON "public"."questionnaire_periods" FOR INSERT TO "authenticated" WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "periods_select" ON "public"."questionnaire_periods" FOR SELECT TO "authenticated" USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "periods_update" ON "public"."questionnaire_periods" FOR UPDATE TO "authenticated" USING (("tenant_id" = "public"."current_tenant_id"()));
...
CREATE POLICY "saas_admin_manage_system_templates" ON "public"."questionnaires" USING ((("creator_type" = 'system'::"text") AND ("public"."current_employee_app_role"() = 'developer'::"text")));



CREATE POLICY "sc_delete_same_tenant" ON "public"."succession_candidates" FOR DELETE USING (("tenant_id" = "public"."current_tenant_id"()));
...
CREATE POLICY "sc_insert_same_tenant" ON "public"."succession_candidates" FOR INSERT WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));
...
CREATE POLICY "sc_select_same_tenant" ON "public"."succession_candidates" FOR SELECT USING (("tenant_id" = "public"."current_tenant_id"()));
...
CREATE POLICY "sc_update_same_tenant" ON "public"."succession_candidates" FOR UPDATE USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));
...
CREATE POLICY "sp_delete_same_tenant" ON "public"."succession_positions" FOR DELETE USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "sp_insert_same_tenant" ON "public"."succession_positions" FOR INSERT WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "sp_select_same_tenant" ON "public"."succession_positions" FOR SELECT USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "sp_update_same_tenant" ON "public"."succession_positions" FOR UPDATE USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));
...
CREATE POLICY "supa_division_establishment_anchors_all" ON "public"."division_establishment_anchors" USING (("auth"."uid"() = 'e97488f9-02be-4b0b-9dc9-ddb0c2902999'::"uuid")) WITH CHECK (("auth"."uid"() = 'e97488f9-02be-4b0b-9dc9-ddb0c2902999'::"uuid"));



CREATE POLICY "supa_division_establishments_all" ON "public"."division_establishments" USING (("auth"."uid"() = 'e97488f9-02be-4b0b-9dc9-ddb0c2902999'::"uuid")) WITH CHECK (("auth"."uid"() = 'e97488f9-02be-4b0b-9dc9-ddb0c2902999'::"uuid"));
...
CREATE POLICY "supa_tenant_stress_settings_all" ON "public"."tenant_stress_settings" USING (("auth"."uid"() = 'e97488f9-02be-4b0b-9dc9-ddb0c2902999'::"uuid")) WITH CHECK (("auth"."uid"() = 'e97488f9-02be-4b0b-9dc9-ddb0c2902999'::"uuid"));
...
CREATE POLICY "tenant_contracts_select_same_tenant" ON "public"."tenant_contracts" FOR SELECT USING (("tenant_id" = "public"."current_tenant_id"()));
...
CREATE POLICY "tenant_isolation" ON "public"."el_course_requirement_mappings" USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."el_course_skill_level_mappings" USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."employee_approvers" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."employee_career_goals" USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."employee_qualifications" USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."employee_recommended_courses" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."employee_skill_assignments" USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."employee_skill_level_achievements" USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."employee_skill_requirement_history" USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."employee_skill_requirement_selections" USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."employee_skill_self_evaluations" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."employee_training_plans" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."evaluation_flow_logs" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."evaluation_goals" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."evaluation_periods" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."evaluation_reminders" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."evaluation_scores" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."evaluation_sheets" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."evaluation_template_items" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."evaluation_templates" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."grade_evaluation_criteria" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."lifecycle_instances" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."lifecycle_task_templates" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."lifecycle_tasks" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."one_on_one_sessions" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."one_on_one_theme_templates" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."project_simulations" USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."qualifications" USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."simulation_assigned_members" USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."simulation_position_requirements" USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."simulation_positions" USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."skill_feedback_comments" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."skill_growth_milestones" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."skill_levels" USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."skill_map_drafts" USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."skill_requirement_applications" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."skill_requirements" USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."skill_role_applications" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."tenant_skill_level_sets" USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."tenant_skills" USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_isolation" ON "public"."training_plan_template_courses" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."training_plan_templates" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."turnover_risk_action_logs" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));



CREATE POLICY "tenant_isolation" ON "public"."turnover_risk_scores" USING (("tenant_id" = ( SELECT "employees"."tenant_id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "tenant_stress_settings_delete_same_tenant" ON "public"."tenant_stress_settings" FOR DELETE USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_stress_settings_insert_same_tenant" ON "public"."tenant_stress_settings" FOR INSERT WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_stress_settings_select_same_tenant" ON "public"."tenant_stress_settings" FOR SELECT USING (("tenant_id" = "public"."current_tenant_id"()));



CREATE POLICY "tenant_stress_settings_update_same_tenant" ON "public"."tenant_stress_settings" FOR UPDATE USING (("tenant_id" = "public"."current_tenant_id"())) WITH CHECK (("tenant_id" = "public"."current_tenant_id"()));
...
GRANT ALL ON FUNCTION "public"."resolve_active_period_for_employee_v2"("p_employee_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."resolve_active_period_for_employee_v2"("p_employee_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."resolve_active_period_for_employee_v2"("p_employee_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."resolve_division_establishment_for_division"("p_division_id" "uuid", "p_tenant_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."resolve_division_establishment_for_division"("p_division_id" "uuid", "p_tenant_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."resolve_division_establishment_for_division"("p_division_id" "uuid", "p_tenant_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."resolve_division_establishment_for_employee"("p_employee_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."resolve_division_establishment_for_employee"("p_employee_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."resolve_division_establishment_for_employee"("p_employee_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."stress_group_analysis_for_layer"("p_tenant_id" "uuid", "p_layer" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."stress_group_analysis_for_layer"("p_tenant_id" "uuid", "p_layer" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."stress_group_analysis_for_layer"("p_tenant_id" "uuid", "p_layer" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_candidate_timestamps"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_candidate_timestamps"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_candidate_timestamps"() TO "service_role";
...
GRANT ALL ON TABLE "public"."el_assignments" TO "anon";
GRANT ALL ON TABLE "public"."el_assignments" TO "authenticated";
GRANT ALL ON TABLE "public"."el_assignments" TO "service_role";



GRANT ALL ON TABLE "public"."el_checklist_completions" TO "anon";
GRANT ALL ON TABLE "public"."el_checklist_completions" TO "authenticated";
GRANT ALL ON TABLE "public"."el_checklist_completions" TO "service_role";



GRANT ALL ON TABLE "public"."el_checklist_items" TO "anon";
GRANT ALL ON TABLE "public"."el_checklist_items" TO "authenticated";
GRANT ALL ON TABLE "public"."el_checklist_items" TO "service_role";



GRANT ALL ON TABLE "public"."el_course_requirement_mappings" TO "anon";
GRANT ALL ON TABLE "public"."el_course_requirement_mappings" TO "authenticated";
GRANT ALL ON TABLE "public"."el_course_requirement_mappings" TO "service_role";



GRANT ALL ON TABLE "public"."el_course_skill_level_mappings" TO "anon";
GRANT ALL ON TABLE "public"."el_course_skill_level_mappings" TO "authenticated";
GRANT ALL ON TABLE "public"."el_course_skill_level_mappings" TO "service_role";



GRANT ALL ON TABLE "public"."el_courses" TO "anon";
GRANT ALL ON TABLE "public"."el_courses" TO "authenticated";
GRANT ALL ON TABLE "public"."el_courses" TO "service_role";



GRANT ALL ON TABLE "public"."el_progress" TO "anon";
GRANT ALL ON TABLE "public"."el_progress" TO "authenticated";
GRANT ALL ON TABLE "public"."el_progress" TO "service_role";



GRANT ALL ON TABLE "public"."el_quiz_options" TO "anon";
GRANT ALL ON TABLE "public"."el_quiz_options" TO "authenticated";
GRANT ALL ON TABLE "public"."el_quiz_options" TO "service_role";



GRANT ALL ON TABLE "public"."el_quiz_questions" TO "anon";
GRANT ALL ON TABLE "public"."el_quiz_questions" TO "authenticated";
GRANT ALL ON TABLE "public"."el_quiz_questions" TO "service_role";



GRANT ALL ON TABLE "public"."el_scenario_branches" TO "anon";
GRANT ALL ON TABLE "public"."el_scenario_branches" TO "authenticated";
GRANT ALL ON TABLE "public"."el_scenario_branches" TO "service_role";



GRANT ALL ON TABLE "public"."el_slides" TO "anon";
GRANT ALL ON TABLE "public"."el_slides" TO "authenticated";
GRANT ALL ON TABLE "public"."el_slides" TO "service_role";



GRANT ALL ON TABLE "public"."employee_approvers" TO "anon";
GRANT ALL ON TABLE "public"."employee_approvers" TO "authenticated";
GRANT ALL ON TABLE "public"."employee_approvers" TO "service_role";



GRANT ALL ON TABLE "public"."employee_career_goals" TO "anon";
GRANT ALL ON TABLE "public"."employee_career_goals" TO "authenticated";
GRANT ALL ON TABLE "public"."employee_career_goals" TO "service_role";
...
GRANT ALL ON TABLE "public"."employee_recommended_courses" TO "anon";
GRANT ALL ON TABLE "public"."employee_recommended_courses" TO "authenticated";
GRANT ALL ON TABLE "public"."employee_recommended_courses" TO "service_role";



GRANT ALL ON TABLE "public"."employee_skill_assignments" TO "anon";
GRANT ALL ON TABLE "public"."employee_skill_assignments" TO "authenticated";
GRANT ALL ON TABLE "public"."employee_skill_assignments" TO "service_role";



GRANT ALL ON TABLE "public"."employee_skill_level_achievements" TO "anon";
GRANT ALL ON TABLE "public"."employee_skill_level_achievements" TO "authenticated";
GRANT ALL ON TABLE "public"."employee_skill_level_achievements" TO "service_role";



GRANT ALL ON TABLE "public"."employee_skill_requirement_history" TO "anon";
GRANT ALL ON TABLE "public"."employee_skill_requirement_history" TO "authenticated";
GRANT ALL ON TABLE "public"."employee_skill_requirement_history" TO "service_role";



GRANT ALL ON TABLE "public"."employee_skill_requirement_selections" TO "anon";
GRANT ALL ON TABLE "public"."employee_skill_requirement_selections" TO "authenticated";
GRANT ALL ON TABLE "public"."employee_skill_requirement_selections" TO "service_role";



GRANT ALL ON TABLE "public"."employee_skill_self_evaluations" TO "anon";
GRANT ALL ON TABLE "public"."employee_skill_self_evaluations" TO "authenticated";
GRANT ALL ON TABLE "public"."employee_skill_self_evaluations" TO "service_role";



GRANT ALL ON TABLE "public"."employee_training_plans" TO "anon";
GRANT ALL ON TABLE "public"."employee_training_plans" TO "authenticated";
GRANT ALL ON TABLE "public"."employee_training_plans" TO "service_role";
...
GRANT ALL ON TABLE "public"."evaluation_flow_logs" TO "anon";
GRANT ALL ON TABLE "public"."evaluation_flow_logs" TO "authenticated";
GRANT ALL ON TABLE "public"."evaluation_flow_logs" TO "service_role";



GRANT ALL ON TABLE "public"."evaluation_goals" TO "anon";
GRANT ALL ON TABLE "public"."evaluation_goals" TO "authenticated";
GRANT ALL ON TABLE "public"."evaluation_goals" TO "service_role";



GRANT ALL ON TABLE "public"."evaluation_periods" TO "anon";
GRANT ALL ON TABLE "public"."evaluation_periods" TO "authenticated";
GRANT ALL ON TABLE "public"."evaluation_periods" TO "service_role";



GRANT ALL ON TABLE "public"."evaluation_reminders" TO "anon";
GRANT ALL ON TABLE "public"."evaluation_reminders" TO "authenticated";
GRANT ALL ON TABLE "public"."evaluation_reminders" TO "service_role";
...
GRANT ALL ON TABLE "public"."evaluation_sheets" TO "anon";
GRANT ALL ON TABLE "public"."evaluation_sheets" TO "authenticated";
GRANT ALL ON TABLE "public"."evaluation_sheets" TO "service_role";



GRANT ALL ON TABLE "public"."evaluation_template_items" TO "anon";
GRANT ALL ON TABLE "public"."evaluation_template_items" TO "authenticated";
GRANT ALL ON TABLE "public"."evaluation_template_items" TO "service_role";
...
GRANT ALL ON TABLE "public"."global_evaluation_template_items" TO "anon";
GRANT ALL ON TABLE "public"."global_evaluation_template_items" TO "authenticated";
GRANT ALL ON TABLE "public"."global_evaluation_template_items" TO "service_role";



GRANT ALL ON TABLE "public"."global_evaluation_templates" TO "anon";
GRANT ALL ON TABLE "public"."global_evaluation_templates" TO "authenticated";
GRANT ALL ON TABLE "public"."global_evaluation_templates" TO "service_role";



GRANT ALL ON TABLE "public"."global_skill_level_sets" TO "anon";
GRANT ALL ON TABLE "public"."global_skill_level_sets" TO "authenticated";
GRANT ALL ON TABLE "public"."global_skill_level_sets" TO "service_role";



GRANT ALL ON TABLE "public"."global_skill_levels" TO "anon";
GRANT ALL ON TABLE "public"."global_skill_levels" TO "authenticated";
GRANT ALL ON TABLE "public"."global_skill_levels" TO "service_role";



GRANT ALL ON TABLE "public"."grade_evaluation_criteria" TO "anon";
GRANT ALL ON TABLE "public"."grade_evaluation_criteria" TO "authenticated";
GRANT ALL ON TABLE "public"."grade_evaluation_criteria" TO "service_role";
...
GRANT ALL ON TABLE "public"."lifecycle_instances" TO "anon";
GRANT ALL ON TABLE "public"."lifecycle_instances" TO "authenticated";
GRANT ALL ON TABLE "public"."lifecycle_instances" TO "service_role";



GRANT ALL ON TABLE "public"."lifecycle_task_templates" TO "anon";
GRANT ALL ON TABLE "public"."lifecycle_task_templates" TO "authenticated";
GRANT ALL ON TABLE "public"."lifecycle_task_templates" TO "service_role";



GRANT ALL ON TABLE "public"."lifecycle_tasks" TO "anon";
GRANT ALL ON TABLE "public"."lifecycle_tasks" TO "authenticated";
GRANT ALL ON TABLE "public"."lifecycle_tasks" TO "service_role";
...
GRANT ALL ON TABLE "public"."one_on_one_sessions" TO "anon";
GRANT ALL ON TABLE "public"."one_on_one_sessions" TO "authenticated";
GRANT ALL ON TABLE "public"."one_on_one_sessions" TO "service_role";



GRANT ALL ON TABLE "public"."one_on_one_theme_templates" TO "anon";
GRANT ALL ON TABLE "public"."one_on_one_theme_templates" TO "authenticated";
GRANT ALL ON TABLE "public"."one_on_one_theme_templates" TO "service_role";
...
GRANT ALL ON TABLE "public"."project_simulations" TO "anon";
GRANT ALL ON TABLE "public"."project_simulations" TO "authenticated";
GRANT ALL ON TABLE "public"."project_simulations" TO "service_role";
...
GRANT ALL ON TABLE "public"."questionnaire_periods" TO "anon";
GRANT ALL ON TABLE "public"."questionnaire_periods" TO "authenticated";
GRANT ALL ON TABLE "public"."questionnaire_periods" TO "service_role";
...
GRANT ALL ON TABLE "public"."simulation_assigned_members" TO "anon";
GRANT ALL ON TABLE "public"."simulation_assigned_members" TO "authenticated";
GRANT ALL ON TABLE "public"."simulation_assigned_members" TO "service_role";



GRANT ALL ON TABLE "public"."simulation_position_requirements" TO "anon";
GRANT ALL ON TABLE "public"."simulation_position_requirements" TO "authenticated";
GRANT ALL ON TABLE "public"."simulation_position_requirements" TO "service_role";



GRANT ALL ON TABLE "public"."simulation_positions" TO "anon";
GRANT ALL ON TABLE "public"."simulation_positions" TO "authenticated";
GRANT ALL ON TABLE "public"."simulation_positions" TO "service_role";



GRANT ALL ON TABLE "public"."skill_consultations" TO "anon";
GRANT ALL ON TABLE "public"."skill_consultations" TO "authenticated";
GRANT ALL ON TABLE "public"."skill_consultations" TO "service_role";



GRANT ALL ON TABLE "public"."skill_feedback_comments" TO "anon";
GRANT ALL ON TABLE "public"."skill_feedback_comments" TO "authenticated";
GRANT ALL ON TABLE "public"."skill_feedback_comments" TO "service_role";



GRANT ALL ON TABLE "public"."skill_growth_milestones" TO "anon";
GRANT ALL ON TABLE "public"."skill_growth_milestones" TO "authenticated";
GRANT ALL ON TABLE "public"."skill_growth_milestones" TO "service_role";
...
GRANT ALL ON TABLE "public"."skill_map_drafts" TO "anon";
GRANT ALL ON TABLE "public"."skill_map_drafts" TO "authenticated";
GRANT ALL ON TABLE "public"."skill_map_drafts" TO "service_role";



GRANT ALL ON TABLE "public"."skill_requirement_applications" TO "anon";
GRANT ALL ON TABLE "public"."skill_requirement_applications" TO "authenticated";
GRANT ALL ON TABLE "public"."skill_requirement_applications" TO "service_role";
...
GRANT ALL ON TABLE "public"."skill_role_applications" TO "anon";
GRANT ALL ON TABLE "public"."skill_role_applications" TO "authenticated";
GRANT ALL ON TABLE "public"."skill_role_applications" TO "service_role";
...
GRANT ALL ON TABLE "public"."stress_check_period_divisions" TO "anon";
GRANT ALL ON TABLE "public"."stress_check_period_divisions" TO "authenticated";
GRANT ALL ON TABLE "public"."stress_check_period_divisions" TO "service_role";
...
GRANT ALL ON TABLE "public"."stress_group_analysis_establishment" TO "anon";
GRANT ALL ON TABLE "public"."stress_group_analysis_establishment" TO "authenticated";
GRANT ALL ON TABLE "public"."stress_group_analysis_establishment" TO "service_role";
...
GRANT ALL ON TABLE "public"."succession_candidates" TO "anon";
GRANT ALL ON TABLE "public"."succession_candidates" TO "authenticated";
GRANT ALL ON TABLE "public"."succession_candidates" TO "service_role";



GRANT ALL ON TABLE "public"."succession_positions" TO "anon";
GRANT ALL ON TABLE "public"."succession_positions" TO "authenticated";
GRANT ALL ON TABLE "public"."succession_positions" TO "service_role";
...
GRANT ALL ON TABLE "public"."tenant_contracts" TO "anon";
GRANT ALL ON TABLE "public"."tenant_contracts" TO "authenticated";
GRANT ALL ON TABLE "public"."tenant_contracts" TO "service_role";
...
GRANT ALL ON TABLE "public"."tenant_skill_level_sets" TO "anon";
GRANT ALL ON TABLE "public"."tenant_skill_level_sets" TO "authenticated";
GRANT ALL ON TABLE "public"."tenant_skill_level_sets" TO "service_role";



GRANT ALL ON TABLE "public"."tenant_skills" TO "anon";
GRANT ALL ON TABLE "public"."tenant_skills" TO "authenticated";
GRANT ALL ON TABLE "public"."tenant_skills" TO "service_role";
...
GRANT ALL ON TABLE "public"."training_plan_template_courses" TO "anon";
GRANT ALL ON TABLE "public"."training_plan_template_courses" TO "authenticated";
GRANT ALL ON TABLE "public"."training_plan_template_courses" TO "service_role";



GRANT ALL ON TABLE "public"."training_plan_templates" TO "anon";
GRANT ALL ON TABLE "public"."training_plan_templates" TO "authenticated";
GRANT ALL ON TABLE "public"."training_plan_templates" TO "service_role";



GRANT ALL ON TABLE "public"."turnover_risk_action_logs" TO "anon";
GRANT ALL ON TABLE "public"."turnover_risk_action_logs" TO "authenticated";
GRANT ALL ON TABLE "public"."turnover_risk_action_logs" TO "service_role";



GRANT ALL ON TABLE "public"."turnover_risk_scores" TO "anon";
GRANT ALL ON TABLE "public"."turnover_risk_scores" TO "authenticated";
GRANT ALL ON TABLE "public"."turnover_risk_scores" TO "service_role";
