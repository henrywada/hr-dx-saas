...
| Phase 2 | 工数入力・工数分布・コメントスレッド             | 一部完了（コメントスレッド完了／工数管理は実装中） |
...
| #   | 内容                                                      | 状態   |
| --- | --------------------------------------------------------- | ------ |
| 1   | `task_work_logs` テーブル・RLS ポリシーのマイグレーション | 未着手 |
| 2   | 型・Zod スキーマ・`queries.ts`/`actions.ts`               | 未着手 |
| 3   | `TaskDetailModal` への工数記録セクション追加              | 未着手 |
| 4   | 工数分布グラフコンポーネント（Recharts）・色定数ファイル  | 未着手 |
| 5   | タスクグループ詳細ページへのメンバー別グラフ追加          | 未着手 |
| 6   | 目標詳細ページへのグループ別グラフ追加                    | 未着手 |
| 7   | 手動 E2E 確認                                             | 未着手 |
