...
| Phase 2 | 工数入力・工数分布・コメントスレッド             | 着手中（コメントスレッド） |
...
| #   | 内容                                                                   | 状態   |
| --- | ---------------------------------------------------------------------- | ------ |
| 1   | `task_comments` テーブル・RLS ポリシー・ヘルパー関数のマイグレーション | 未着手 |
| 2   | 型・Zod スキーマ・`queries.ts`/`actions.ts`                            | 未着手 |
| 3   | `TaskDetailModal`（コメントスレッド含む）                              | 未着手 |
| 4   | `TaskCard`/`KanbanBoard` の改修                                        | 未着手 |
| 5   | タスクグループ詳細ページへのコメント欄追加                             | 未着手 |
| 6   | 手動 E2E 確認                                                          | 未着手 |
