...
| Phase 3 | 組織ツリー・進捗サマリ・通知連携・アニメーション | 一部着手（進捗サマリ完了／通知連携実装中／残り2項目は未着手） |
...
| #   | 内容                                                                    | 状態   |
| --- | ----------------------------------------------------------------------- | ------ |
| 1   | `src/features/task-management/feed-provider.ts`（割当・コメント両対応） | 未着手 |
| 2   | `FeedItemCategory`・`registry.ts`・`FeedItemRow.tsx` への登録           | 未着手 |
| 3   | `ui_dashboard_element` マイグレーション                                 | 未着手 |
| 4   | 手動 E2E 確認                                                           | 未着手 |
