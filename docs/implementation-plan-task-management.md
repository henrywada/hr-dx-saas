...
| #   | 内容                                                                  | 状態   |
| --- | --------------------------------------------------------------------- | ------ |
| 1   | `org-tree.ts`（ツリー構築・レイアウト純粋関数）＋ユニットテスト       | 未着手 |
| 2   | `getObjectiveOrgTree`（`queries.ts`）                                 | 未着手 |
| 3   | `OrgTreeSection.tsx`・`@xyflow/react`導入・目標詳細ページへの組み込み | 未着手 |
| 4   | 全体テスト実行・手動E2E確認・PRDステータス更新                        | 未着手 |
