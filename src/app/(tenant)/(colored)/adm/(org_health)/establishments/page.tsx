...
export default async function DivisionEstablishmentsPage() {
  ...
  const [establishmentsPayload, divisions, settings, unassignedCount] = await Promise.all([
  ...
  const { establishments, anchorEmployeeCounts } = establishmentsPayload
  ...
  return (
    <div className="p-6 space-y-6">
      <header className="relative pl-5">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-slate-900">ストレスチェック実施拠点の登録</h1>
