...
const MARKDOWN = `# 勤怠管理一覧（人事） 各カードの見方・仕組みマニュアル

この勤怠管理一覧（人事）は、テナント内の全従業員の勤怠状況を一元的に把握し、残業時間やアラート、法令違反リスクを管理するための人事担当者専用画面です。ここでは、画面上部に表示される4つの主要な統計カードの見方と仕組みについて詳しく解説します。
...
これら4つのカードは、勤怠管理一覧（人事）の中核をなす統計情報であり、人事担当者が組織の労働時間状況を俯瞰的に把握するための重要なツールです。
...
/** 勤怠管理一覧（人事）の統計カードの見方・仕組み（マークダウン）を表示するモーダル */
