  ...
  return (
    <div className="space-y-8">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">サービス管理</h1>
          <p className="text-sm text-slate-500 mt-1">サービス管理。</p>
        </div>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <span
                  className={`text-xs font-medium px-2 py-1 rounded-full ${card.trendUp ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'}`}
                >
                  {card.trend}
                </span>
              </div>
