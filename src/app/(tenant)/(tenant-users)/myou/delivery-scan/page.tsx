...
import { DeliveryScanHelpModalTrigger } from '../components/DeliveryScanHelpModalTrigger'
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mt-8 bg-gray-50 rounded-lg p-4 border border-gray-200">
        ...
        <ul className="text-xs text-gray-600 space-y-1 ml-4 list-disc">
          ...
          <li>
            「QRスキャン」タブ：カメラ許可のボタンを押してからロットQRをスキャンしてください。カメラが使えないときはQR内容の貼り付けでも読み取れます。「在庫表より」タブ：出荷したいロットの「出荷」ボタンから数量を指定して出荷できます。
          </li>
          <li>
