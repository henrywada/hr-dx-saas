...
import { commitSlideImageAfterDirectUpload } from '@/features/e-learning/slide-media-upload'
...
export async function POST(
  ...
  try {
    const url = await commitSlideImageAfterDirectUpload({ slideId, courseId, storagePath })
