...
import { prepareSlideImageSignedUpload } from '@/features/e-learning/slide-media-upload'

/** 小さい JSON のみ（ファイル本体は Supabase Storage へ直 PUT） */
export async function POST(
  ...
  try {
    const data = await prepareSlideImageSignedUpload({
      slideId,
      fileName,
      contentType,
      fileSize,
