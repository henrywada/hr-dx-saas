...
export interface ProgressStats {
  ...
  /** 拠点別進捗（拠点マスタ or 実施グループ対象部署） */
  establishments?: EstablishmentProgressStat[]
  /**
   * 拠点別進捗の集計元。
   * - master: division_establishments
   * - period_divisions: 実施グループの対象部署（拠点マスタ未登録時のフォールバック）
   */
  establishmentSource?: 'master' | 'period_divisions'
}
