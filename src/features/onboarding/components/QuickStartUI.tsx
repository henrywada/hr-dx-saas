        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 text-center space-y-8 animate-in fade-in zoom-in duration-300">
          ...
          <div className="space-y-4 text-left">
            ...
            <input
              ...
              className="w-full px-5 py-4 text-lg rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-[#FD7601] outline-none transition shadow-sm"
              disabled={isPending}
            />
          </div>
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-4 px-4 bg-gradient-to-r from-orange-600 to-blue-600 text-white font-bold text-lg rounded-xl shadow-md hover:shadow-lg hover:-translate-y-0.5 transition disabled:opacity-50 disabled:transform-none"
          >
            ✨ AIでセットアップ
          </button>
        </div>
      ...
      {step === 2 && (
        <div className="bg-white p-16 rounded-2xl shadow-xl border border-gray-100 text-center space-y-6 animate-in fade-in duration-300">
          <div className="flex justify-center mb-6">
             <svg className="animate-spin h-12 w-12 text-[#FD7601]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 space-y-6 animate-in slide-in-from-bottom-4 fade-in duration-500">
          ...
          <div className="pt-4 flex gap-3">
             ...
             <button 
                ...
                disabled={isSaving}
                className="flex-[2] px-4 py-3 bg-[#FD7601] text-white font-bold rounded-xl shadow-md hover:bg-orange-700 hover:shadow-lg hover:-translate-y-0.5 transition disabled:opacity-50"
              >
