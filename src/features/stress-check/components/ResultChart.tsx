  ...
  return (
    <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200 px-4 py-3 text-sm z-50">
      ...
      <p className="text-gray-600 mt-1">
        評価点: <span className="font-semibold text-[#FD7601]">{d.value} / 5.0</span>
      </p>
                  ...
                  >
                    ...
                    <td className="py-2.5 px-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`text-xs font-medium whitespace-nowrap ${level.textColor}`}
                        >
                          {level.label}
                        </span>
                      </div>
...
export default function ResultChart({ result }: ResultChartProps) {
  ...
  return (
    <div className="space-y-6">
      {/* 注釈 */}
      <div className="flex items-start gap-2 p-4 rounded-xl bg-[#f6f8fa] border border-[#e2e6ec] text-sm text-[#FD7601]">
