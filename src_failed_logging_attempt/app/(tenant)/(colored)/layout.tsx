...
import { Sidebar } from "@/components/layout/Sidebar_adm";
...
export default async function TenantLayout({
  ...
  let userName = user?.user_metadata?.name || "Guest User";
  let role = user?.user_metadata?.role || "member";

  // Optionally fetch from employees if name is missing or to override
  if (user) {
